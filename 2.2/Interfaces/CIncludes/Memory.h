...
/*****************************************************************************
	...
	The following six routines are System7 only. The latter four of them are
	intended to be used by developers writing drivers:
	...
	The first two functions (BlockMove and BlockMoveData) exist in both
	“InterfaceLib” and “DriverServicesLib.” You cannot link with both libraries.
	
	The latter four (BlockMoveUncached, BlockMoveDataUncached, BlockZero and
	BlockZeroUncached) do not exist in “InterfaceLib.” You must link with
	“DriverServicesLib” to access them.

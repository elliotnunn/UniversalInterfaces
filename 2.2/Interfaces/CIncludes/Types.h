...
/*
	...
	Metrowerks CW10 C++ compiler has true and false built-in, but the STL 
	library wants them #defined...
	
	The following works with ETO #21 and CW10.  It will change in the future
	as compilers change.
*/
#ifdef __MWERKS__
	#if !__option(bool)
	...
	#endif
/*
#elif defined(__cplusplus) && ( defined(__MRC__) || defined(__SC__) )
	#if (__MRC__ >= 0x211) || (__SC__ >= 0x812)
		#if !__option(bool)
			enum {false, true};
		#endif
	#endif

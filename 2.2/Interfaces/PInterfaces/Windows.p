...
PROCEDURE GetWMgrPort(VAR wPort: GrafPtr);
	...
	INLINE $A910;
	{$ENDC}
FUNCTION NewWindow(wStorage: UNIV Ptr; {CONST}VAR boundsRect: Rect; title: ConstStr255Param; visible: BOOLEAN; theProc: INTEGER; behind: WindowRef; goAwayFlag: BOOLEAN; refCon: LONGINT): WindowRef;
	{$IFC NOT GENERATINGCFM}
	INLINE $A913;
	{$ENDC}
...
PROCEDURE CalcVisBehind(startWindow: WindowRef; clobberedRgn: RgnHandle);
	...
	INLINE $A90A;
	{$ENDC}
FUNCTION GrowWindow(theWindow: WindowRef; startPt: Point; {CONST}VAR bBox: Rect): LONGINT;
	{$IFC NOT GENERATINGCFM}
	INLINE $A92B;
	{$ENDC}
...
PROCEDURE SetDeskCPat(deskPixPat: PixPatHandle);
	...
	INLINE $AA47;
	{$ENDC}
FUNCTION NewCWindow(wStorage: UNIV Ptr; {CONST}VAR boundsRect: Rect; title: ConstStr255Param; visible: BOOLEAN; procID: INTEGER; behind: WindowRef; goAwayFlag: BOOLEAN; refCon: LONGINT): WindowRef;
	{$IFC NOT GENERATINGCFM}
	INLINE $AA45;
	{$ENDC}

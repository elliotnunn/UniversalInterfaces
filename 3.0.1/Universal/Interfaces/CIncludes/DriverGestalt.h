...
enum {
	...
	kdgPhysDriveIconSuite		= FOUR_CHAR_CODE('dics'),		/* [call sync only] icon suite for Disk Driver physical drive (formerly in csCode 22) */
	kdgMediaIconSuite			= FOUR_CHAR_CODE('mics'),		/* [call sync only] icon suite for Disk Driver media (formerly in csCode 21) */
	kdgMediaName				= FOUR_CHAR_CODE('mnam')		/* pascal string describing the Disk Driver (formerly in csCode 21) */
};

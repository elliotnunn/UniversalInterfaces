...
struct HFSCIRec {
	...
	HFSCIProcPtr 					compInterfProc;				/* pointer to file system call processing code */
	Lg2PhysProcPtr 					log2PhyProc;				/* pointer to Lg2PhysProc() code */
...
struct DICIRec {
	long 							compInterfMask;				/* component flags */
	DICIProcPtr 					compInterfProc;				/* pointer to call processing code */
...
struct FSDRec {
	...
	FSDCommProcPtr 					fileSystemCommProc;			/* communication proc with the FFS */
	long 							reserved3;					/* --reserved, must be zero-- */
	long 							reserved2;					/* --reserved, must be zero-- */
	long 							reserved1;					/* --reserved, must be zero-- */

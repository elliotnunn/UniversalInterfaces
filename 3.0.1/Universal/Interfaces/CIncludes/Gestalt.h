...
enum {
	...
	gestaltAWS8550				= gestaltPowerMac8500,
...
enum {
	gestaltALMAttr				= FOUR_CHAR_CODE('trip'),		/* Apple Location Manager attributes (see also gestaltALMVers) */
...
enum {
	gestaltALMVers				= FOUR_CHAR_CODE('walk')		/* Apple Location Manager version (see also gestaltALMAttr) */
};

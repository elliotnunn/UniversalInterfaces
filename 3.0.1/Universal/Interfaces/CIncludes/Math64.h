...
EXTERN_API_C( SInt64 )
S64Multiply						(SInt64 				xparam,
								 SInt64 				yparam);

EXTERN_API_C( SInt64 )
S64Divide						(SInt64 				dividend,
								 SInt64 				divisor,
								 SInt64 *				remainder);
...
EXTERN_API_C( SInt64 )
S64BitwiseAnd					(SInt64 				left,
								 SInt64 				right);

EXTERN_API_C( SInt64 )
S64BitwiseOr					(SInt64 				left,
								 SInt64 				right);

EXTERN_API_C( SInt64 )
S64BitwiseEor					(SInt64 				left,
								 SInt64 				right);
...
EXTERN_API_C( SInt64 )
S64ShiftRight					(SInt64 				value,
								 UInt32 				shift);

EXTERN_API_C( SInt64 )
S64ShiftLeft					(SInt64 				value,
								 UInt32 				shift);
...
EXTERN_API_C( UInt64 )
U64Multiply						(UInt64 				xparam,
								 UInt64 				yparam);

EXTERN_API_C( UInt64 )
U64Divide						(UInt64 				dividend,
								 UInt64 				divisor,
								 UInt64 *				remainder);
...
EXTERN_API_C( UInt64 )
U64BitwiseAnd					(UInt64 				left,
								 UInt64 				right);

EXTERN_API_C( UInt64 )
U64BitwiseOr					(UInt64 				left,
								 UInt64 				right);

EXTERN_API_C( UInt64 )
U64BitwiseEor					(UInt64 				left,
								 UInt64 				right);
...
EXTERN_API_C( UInt64 )
U64ShiftRight					(UInt64 				value,
								 UInt32 				shift);

EXTERN_API_C( UInt64 )
U64ShiftLeft					(UInt64 				value,
								 UInt32 				shift);

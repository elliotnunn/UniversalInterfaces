...
typedef CALLBACK_API( ComponentResult , TweenerDataProcPtr )(TweenRecord *tr, void *tweenData, long tweenDataSize, long dataDescriptionSeed, Handle dataDescription, ICMCompletionProcRecordPtr asyncCompletionProc, ProcPtr transferProc, void *refCon);
...
DataHPreextend					(DataHandler 			dh,
								 long 					maxToAdd,
								 long *					spaceAdded)							FIVEWORDINLINE(0x2F3C, 0x0008, 0x0016, 0x7000, 0xA82A);
...
VDPreflightDestination			(VideoDigitizerComponent  ci,
								 ...
								 PixMap **				dest,
								 Rect *					destRect,
								 MatrixRecord *			m)									FIVEWORDINLINE(0x2F3C, 0x0010, 0x0032, 0x7000, 0xA82A);
...
typedef CALLBACK_API( Boolean , SGModalFilterProcPtr )(DialogPtr theDialog, EventRecord *theEvent, short *itemHit, long refCon);

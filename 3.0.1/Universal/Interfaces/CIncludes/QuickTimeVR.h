...
#define kQTVRAPIMinorVersion kQTVRAPIMinorVersion01
...
enum {
	...
	kQTVRCantPanLeft			= 1 << 0,
	kQTVRCantPanRight			= 1 << 1,
	kQTVRCantPanUp				= 1 << 2,
	kQTVRCantPanDown			= 1 << 3,
	kQTVRCantZoomIn				= 1 << 4,
	kQTVRCantZoomOut			= 1 << 5,
	kQTVRCantTranslateLeft		= 1 << 6,
	kQTVRCantTranslateRight		= 1 << 7,
	kQTVRCantTranslateUp		= 1 << 8,
	kQTVRCantTranslateDown		= 1 << 9
};
...
enum {
	...
	mcFlagQTVRExplicitFlagSet	= 1 << 31						/* bits 0->30 should be interpreted as "explicit on" for the corresponding suppression bits*/
};
...
enum {
	kQTVRBackBufferEveryUpdate	= 1 << 0,
	kQTVRBackBufferEveryIdle	= 1 << 1,
	kQTVRBackBufferAlwaysRefresh = 1 << 2,
	kQTVRBackBufferHorizontal	= 1 << 3						/* not supported in 2.0*/
};

/* Values for flagsIn parameter in QTVRBackBufferImaging callback*/

enum {
	kQTVRBackBufferRectVisible	= 1 << 0,
	kQTVRBackBufferWasRefreshed	= 1 << 1
};

/* Values for flagsOut parameter in QTVRBackBufferImaging callback*/

enum {
	kQTVRBackBufferFlagDidDraw	= 1 << 0,
	kQTVRBackBufferFlagLastFlag	= 1 << 31
};

...
EXTERN_API( void )
SetPort							(GrafPtr 				port)								ONEWORDINLINE(0xA873);
...
EXTERN_API( void )
SetCursor						(const Cursor *			crsr)								ONEWORDINLINE(0xA851);

EXTERN_API( void )
HideCursor						(void)														ONEWORDINLINE(0xA852);

EXTERN_API( void )
ShowCursor						(void)														ONEWORDINLINE(0xA853);
...
EXTERN_API( void )
UnionRect						(const Rect *			src1,
								 const Rect *			src2,
								 Rect *					dstRect)							ONEWORDINLINE(0xA8AB);

EXTERN_API( Boolean )
EqualRect						(const Rect *			rect1,
...
EXTERN_API( void )
FrameRect						(const Rect *			r)									ONEWORDINLINE(0xA8A1);
...
EXTERN_API( void )
InvertRect						(const Rect *			r)									ONEWORDINLINE(0xA8A4);

EXTERN_API( void )
FillRect						(const Rect *			r,
...
EXTERN_API( void )
FrameRgn						(RgnHandle 				rgn)								ONEWORDINLINE(0xA8D2);

EXTERN_API( void )
PaintRgn						(RgnHandle 				rgn)								ONEWORDINLINE(0xA8D3);

EXTERN_API( void )
EraseRgn						(RgnHandle 				rgn)								ONEWORDINLINE(0xA8D4);

EXTERN_API( void )
InvertRgn						(RgnHandle 				rgn)								ONEWORDINLINE(0xA8D5);

EXTERN_API( void )
FillRgn							(RgnHandle 				rgn,
...
GetCursor						(short 					cursorID)							ONEWORDINLINE(0xA9B9);

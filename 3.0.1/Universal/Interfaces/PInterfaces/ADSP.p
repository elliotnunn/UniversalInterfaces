{
 	...
 	Copyright:	© 1986-1993, 1995-1997 by Apple Computer, Inc., all rights reserved
...
TYPE
	...
	ADSPConnectionEventProcPtr = Register68kProcPtr;  { PROCEDURE ADSPConnectionEvent(sourceCCB: TPCCB); }

	ADSPCompletionProcPtr = Register68kProcPtr;  { PROCEDURE ADSPCompletion(thePBPtr: DSPPBPtr); }

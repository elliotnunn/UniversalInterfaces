{
 	...
 	Copyright:	© 1990-1993, 1995-1997 by Apple Computer, Inc., all rights reserved
...
TYPE
	...
	TipFunctionProcPtr = ProcPtr;  { FUNCTION TipFunction(tip: Point; structure: RgnHandle; VAR r: Rect; VAR balloonVariant: BalloonVariant): OSErr; }
...
FUNCTION HMGetHelpMenuHandle(VAR mh: MenuHandle): OSErr;
	...
	{$ENDC}
FUNCTION HMShowBalloon({CONST}VAR inHelpMessage: HMMessageRecord; inTip: Point; VAR inHotRect: Rect; inTipProc: TipFunctionUPP; inWindowProcID: SInt16; inBalloonVariant: BalloonVariant; inMethod: SInt16): OSErr;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}

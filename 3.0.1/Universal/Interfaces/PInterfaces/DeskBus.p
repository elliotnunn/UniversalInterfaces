...

{
	...
	ADBServiceRoutineProcPtr = Register68kProcPtr;  { PROCEDURE ADBServiceRoutine(buffer: Ptr; completionProc: TempADBServiceRoutineUPP; refCon: Ptr; command: LONGINT); }
	...
	ADBServiceRoutineUPP = UniversalProcPtr;
{
	...
	Note: ADBInitProcPtr can only be created in 68K assembly language 
		  since it is a head patch that must JUMP to the previous address
}

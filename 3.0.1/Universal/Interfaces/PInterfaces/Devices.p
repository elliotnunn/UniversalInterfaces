...
FUNCTION GetDriverMemoryFragment(memAddr: Ptr; length: LONGINT; fragName: ConstStr63Param; VAR fragmentConnID: CFragConnectionID; VAR fragmentMain: DriverEntryPointPtr; VAR driverDesc: DriverDescriptionPtr): OSErr; C;
...
FUNCTION InstallDriverFromMemory(memory: Ptr; length: LONGINT; fragName: ConstStr63Param; VAR device: RegEntryID; beginningUnit: UnitNumber; endingUnit: UnitNumber; VAR refNum: DriverRefNum): OSErr; C;

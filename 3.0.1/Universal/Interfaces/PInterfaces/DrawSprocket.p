...
TYPE
	...
	DSpEventProcPtr = ProcPtr;  { FUNCTION DSpEvent(VAR inEvent: EventRecord): BOOLEAN; C; }

	DSpCallbackProcPtr = ProcPtr;  { FUNCTION DSpCallback(inContext: DSpContextReference; inRefCon: UNIV Ptr): BOOLEAN; C; }
	...
	DSpBlitDoneProc = ProcPtr;  { PROCEDURE DSpBlitDoneProc(VAR info: DSpBlitInfo); C; }

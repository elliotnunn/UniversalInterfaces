...
TYPE
	...
	FormatIOProcPtr = ProcPtr;  { FUNCTION FormatIO(selector: FormatIOVerb; VAR PB: FormatIOParamBlock): INTEGER; }

	EditionOpenerProcPtr = ProcPtr;  { FUNCTION EditionOpener(selector: EditionOpenerVerb; VAR PB: EditionOpenerParamBlock): INTEGER; }

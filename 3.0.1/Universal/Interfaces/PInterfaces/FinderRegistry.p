...

{
   ...
   Indentation implies object model hierarchy
	...
	cPreferences				= 'cprf';
	cLabel						= 'clbl';						{  For use by viewer search engines: }
	cOnlineDisk					= 'cods';
	cOnlineLocalDisk			= 'clds';
	cOnlineRemoteDisk			= 'crds';						{  Miscellaneous class definitions }
	cEntireContents				= 'ects';						{ •• BREADCRUMB  pmc - also defined in EntireContents.h }
	cIconFamily					= 'ifam';
...
{  Properties of class cDesktop (subclass of cContainer) }
	pStartupDisk				= 'sdsk';
	pTrash						= 'trsh';						{  NOTE can't use cTrash	 }
...
{  Properties of class cPreferencesWindow (subclass of cWindow) }
	...
	ShowModificationDate		= 'sdat';						{  pShowDate defined above for Views CP }
	...
	pLabel5						= 'lbl5';
	pLabel6						= 'lbl6';
	pLabel7						= 'lbl7';						{ 	pObject									= cObject			// defined above }
...

{
   ...
   NOTE: properties for the special folders must match their respective kXXXFolderType constants
	...
	pFontsFolder				= 'ffnt';						{ 	pIsFrontProcess							= 'pisf',			// defined in AERegistry.r }

...
TYPE
	...
	MSAMIOCompletionProcPtr = Register68kProcPtr;  { PROCEDURE MSAMIOCompletion(VAR paramBlock: TempMSAMParam); }
...
TYPE
	...
	PMSAMGetMsgSummaryPB = RECORD
		...
		msgSummaryOffset:		INTEGER;								{  offset of PMSAM specific data from start of MsgSummary  }
	END;
...
PROCEDURE CallMSAMIOCompletionProc(VAR paramBlock: TempMSAMParam; userRoutine: MSAMIOCompletionUPP);

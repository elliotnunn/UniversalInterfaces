{
 	...
 	Copyright:	© 1989-1993, 1995-1997 by Apple Computer, Inc., all rights reserved
...
TYPE
	...
	PPCOpenPBRec = PACKED RECORD
		...
		csCode:					INTEGER;								{  Requested PPC command  }
		intUse:					INTEGER;								{  Internal Use  }
		intUsePtr:				Ptr;									{  Internal Use  }
		ioCompletion:			PPCCompUPP;								{  12 -->	Completion Routine  }
		ioResult:				OSErr;									{  16 <-- 	Command Result Code  }
		Reserved:				ARRAY [0..4] OF LONGINT;				{  Reserved for PPC, Don't use  }

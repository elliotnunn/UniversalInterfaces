...
{$SETC OS_UNIX := 0 }
{$SETC OS_NEXT := 0 }
{$SETC WINDOW_SYSTEM_MACINTOSH := 0 }
{$SETC WINDOW_SYSTEM_WIN32 := 1 }
{$SETC WINDOW_SYSTEM_X11 := 0 }
{$SETC WINDOW_SYSTEM_NEXT := 0 }
...
CONST
	kQ3PixelTypeRGB32			= {TQ3PixelType}0;				{  Alpha:8 (ignored), R:8, G:8, B:8	 }
	kQ3PixelTypeARGB32			= {TQ3PixelType}1;				{  Alpha:8, R:8, G:8, B:8 			 }
	kQ3PixelTypeRGB16			= {TQ3PixelType}2;				{  Alpha:1 (ignored), R:5, G:5, B:5	 }
	kQ3PixelTypeARGB16			= {TQ3PixelType}3;				{  Alpha:1, R:5, G:5, B:5 			 }
	kQ3PixelTypeRGB16_565		= {TQ3PixelType}4;				{  Win32 only: 16 bits/pixel, R:5, G:6, B:5		 }
	kQ3PixelTypeRGB24			= {TQ3PixelType}5;				{  Win32 only: 24 bits/pixel, R:8, G:8, B:8		 }
...
CONST
	...
	kQ3EndCapMaskInterior		= {TQ3EndCapMasks}$04;
 ...
 ****************************************************************************}
	...
	TQ3Pixmap = RECORD
		...
		height:					LONGINT;
		rowBytes:				LONGINT;
		pixelSize:				LONGINT;								{  MUST be 16 or 32 to use with the	Interactive Renderer on Mac OS }
	...
	TQ3MipmapImage = RECORD
		...
		width:					LONGINT;								{  Width of mipmap, must be power of 2    }
		height:					LONGINT;								{  Height of mipmap, must be power of 2   }
		rowBytes:				LONGINT;								{  Rowbytes of mipmap                     }
		offset:					LONGINT;								{  Offset from image base to this mipmap  }
	END;
	...
	TQ3Mipmap = RECORD
		...
		bitOrder:				TQ3Endian;
		byteOrder:				TQ3Endian;
		reserved:				LONGINT;								{  leave NULL for next version  }
		mipmaps:				ARRAY [0..31] OF TQ3MipmapImage;		{  The actual number of mipmaps is 		 }
																		{  determined from the size of the 		 }
																		{  first mipmap							 }
	END;

FUNCTION Q3Bitmap_Empty(VAR bitmap: TQ3Bitmap): TQ3Status; C;
FUNCTION Q3Bitmap_GetImageSize(width: LONGINT; height: LONGINT): LONGINT; C;
 ...
 * IO Methods
	...
	TQ3FunctionPointer = ProcPtr;  { PROCEDURE TQ3FunctionPointer; C; }

	TQ3MetaHandler = ProcPtr;  { FUNCTION TQ3MetaHandler(methodType: TQ3MethodType): TQ3FunctionPointer; C; }
 ...
 *		These types here are prototypes of how your functions should look.
	...
	TQ3ObjectUnregisterMethod = ProcPtr;  { FUNCTION TQ3ObjectUnregisterMethod(objectClass: TQ3ObjectClass): TQ3Status; C; }

	TQ3XObjectClass = ^LONGINT;
	TQ3XMethodType						= LONGINT;
{
 * Object methods
 }
	TQ3XFunctionPointer = ProcPtr;  { PROCEDURE TQ3XFunctionPointer; C; }

	TQ3XMetaHandler = ProcPtr;  { FUNCTION TQ3XMetaHandler(methodType: TQ3XMethodType): TQ3XFunctionPointer; C; }
 ...
 *		These types here are prototypes of how your functions should look.
	...
	TQ3XObjectUnregisterMethod = ProcPtr;  { FUNCTION TQ3XObjectUnregisterMethod(objectClass: TQ3XObjectClass): TQ3Status; C; }
...
FUNCTION Q3GetVersion(VAR majorRevision: LONGINT; VAR minorRevision: LONGINT): TQ3Status; C;
{
...
FUNCTION Q3GetReleaseVersion(VAR releaseRevision: LONGINT): TQ3Status; C;
...
FUNCTION Q3ObjectClass_Unregister(objectClass: TQ3ObjectClass): TQ3Status; C;
...
TYPE
	...
	TQ3SubClassData = RECORD
		numClasses:				LONGINT;								{  the # of subclass types found for a parent class  }
 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3Object_GetType(object: TQ3Object): LONGINT; C;
FUNCTION Q3Object_GetLeafType(object: TQ3Object): LONGINT; C;
 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3Shared_GetType(sharedObject: TQ3SharedObject): LONGINT; C;
...
FUNCTION Q3Shared_GetEditIndex(sharedObject: TQ3SharedObject): LONGINT; C;
{
 *	Q3Shared_Edited
...
FUNCTION Q3Shape_GetType(shape: TQ3ShapeObject): LONGINT; C;

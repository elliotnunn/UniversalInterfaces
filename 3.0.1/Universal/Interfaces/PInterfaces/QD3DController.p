...
TYPE
	TQ3CursorTrackerNotifyFunc = ProcPtr;  { PROCEDURE TQ3CursorTrackerNotifyFunc; C; }
...
FUNCTION Q3CursorTracker_GetAndClearDeltas(VAR depth: Single; VAR orientation: TQ3Quaternion; VAR hasOrientation: TQ3Boolean; VAR changed: TQ3Boolean; VAR serialNumber: LONGINT): TQ3Status; C;

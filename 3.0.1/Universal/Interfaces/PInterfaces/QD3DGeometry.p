...
FUNCTION Q3Polyhedron_SetVertexPosition(polyhedron: TQ3GeometryObject; index: LONGINT; {CONST}VAR point: TQ3Point3D): TQ3Status; C;
FUNCTION Q3Polyhedron_GetVertexPosition(polyhedron: TQ3GeometryObject; index: LONGINT; VAR point: TQ3Point3D): TQ3Status; C;
FUNCTION Q3Polyhedron_SetVertexAttributeSet(polyhedron: TQ3GeometryObject; index: LONGINT; attributeSet: TQ3AttributeSet): TQ3Status; C;
FUNCTION Q3Polyhedron_GetVertexAttributeSet(polyhedron: TQ3GeometryObject; index: LONGINT; VAR attributeSet: TQ3AttributeSet): TQ3Status; C;
FUNCTION Q3Polyhedron_GetTriangleData(polyhedron: TQ3GeometryObject; triangleIndex: LONGINT; VAR triangleData: TQ3PolyhedronTriangleData): TQ3Status; C;
FUNCTION Q3Polyhedron_SetTriangleData(polyhedron: TQ3GeometryObject; triangleIndex: LONGINT; {CONST}VAR triangleData: TQ3PolyhedronTriangleData): TQ3Status; C;
FUNCTION Q3Polyhedron_GetEdgeData(polyhedron: TQ3GeometryObject; edgeIndex: LONGINT; VAR edgeData: TQ3PolyhedronEdgeData): TQ3Status; C;
FUNCTION Q3Polyhedron_SetEdgeData(polyhedron: TQ3GeometryObject; edgeIndex: LONGINT; {CONST}VAR edgeData: TQ3PolyhedronEdgeData): TQ3Status; C;
...
TYPE
	...
	TQ3TriMeshTriangleData = RECORD
		pointIndices:			ARRAY [0..2] OF LONGINT;
	END;

	TQ3TriMeshEdgeDataPtr = ^TQ3TriMeshEdgeData;
	TQ3TriMeshEdgeData = RECORD
		pointIndices:			ARRAY [0..1] OF LONGINT;
		triangleIndices:		ARRAY [0..1] OF LONGINT;
	END;

...
FUNCTION Q3Point3D_To3DTransformArray({CONST}VAR inPoint3D: TQ3Point3D; {CONST}VAR matrix: TQ3Matrix4x4; VAR outPoint3D: TQ3Point3D; numPoints: LONGINT; inStructSize: LONGINT; outStructSize: LONGINT): TQ3Status; C;
FUNCTION Q3Point3D_To4DTransformArray({CONST}VAR inPoint3D: TQ3Point3D; {CONST}VAR matrix: TQ3Matrix4x4; VAR outPoint4D: TQ3RationalPoint4D; numPoints: LONGINT; inStructSize: LONGINT; outStructSize: LONGINT): TQ3Status; C;
FUNCTION Q3RationalPoint4D_To4DTransformArray({CONST}VAR inPoint4D: TQ3RationalPoint4D; {CONST}VAR matrix: TQ3Matrix4x4; VAR outPoint4D: TQ3RationalPoint4D; numPoints: LONGINT; inStructSize: LONGINT; outStructSize: LONGINT): TQ3Status; C;
 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3Point2D_AffineComb({CONST}VAR points2D: TQ3Point2D; {CONST}VAR weights: Single; nPoints: LONGINT; VAR result: TQ3Point2D): TQ3Point2DPtr; C;
FUNCTION Q3Param2D_AffineComb({CONST}VAR param2D: TQ3Param2D; {CONST}VAR weights: Single; nPoints: LONGINT; VAR result: TQ3Param2D): TQ3Param2DPtr; C;
FUNCTION Q3RationalPoint3D_AffineComb({CONST}VAR points3D: TQ3RationalPoint3D; {CONST}VAR weights: Single; numPoints: LONGINT; VAR result: TQ3RationalPoint3D): TQ3RationalPoint3DPtr; C;
FUNCTION Q3Point3D_AffineComb({CONST}VAR points3D: TQ3Point3D; {CONST}VAR weights: Single; numPoints: LONGINT; VAR result: TQ3Point3D): TQ3Point3DPtr; C;
FUNCTION Q3RationalPoint4D_AffineComb({CONST}VAR points4D: TQ3RationalPoint4D; {CONST}VAR weights: Single; numPoints: LONGINT; VAR result: TQ3RationalPoint4D): TQ3RationalPoint4DPtr; C;
...
FUNCTION Q3Quaternion_SetRotateXYZ(VAR quaternion: TQ3Quaternion; xAngle: Single; yAngle: Single; zAngle: Single): TQ3QuaternionPtr; C;
FUNCTION Q3Quaternion_SetRotateX(VAR quaternion: TQ3Quaternion; angle: Single): TQ3QuaternionPtr; C;
FUNCTION Q3Quaternion_SetRotateY(VAR quaternion: TQ3Quaternion; angle: Single): TQ3QuaternionPtr; C;
FUNCTION Q3Quaternion_SetRotateZ(VAR quaternion: TQ3Quaternion; angle: Single): TQ3QuaternionPtr; C;
...
FUNCTION Q3BoundingBox_SetFromPoints3D(VAR bBox: TQ3BoundingBox; {CONST}VAR point3D: TQ3Point3D; numPoints: LONGINT; structSize: LONGINT): TQ3BoundingBoxPtr; C;
FUNCTION Q3BoundingBox_SetFromRationalPoints4D(VAR bBox: TQ3BoundingBox; {CONST}VAR points4D: TQ3RationalPoint4D; numPoints: LONGINT; structSize: LONGINT): TQ3BoundingBoxPtr; C;
...
FUNCTION Q3BoundingSphere_SetFromPoints3D(VAR bSphere: TQ3BoundingSphere; {CONST}VAR points3D: TQ3Point3D; numPoints: LONGINT; structSize: LONGINT): TQ3BoundingSpherePtr; C;
FUNCTION Q3BoundingSphere_SetFromRationalPoints4D(VAR bSphere: TQ3BoundingSphere; {CONST}VAR points4D: TQ3RationalPoint4D; numPoints: LONGINT; structSize: LONGINT): TQ3BoundingSpherePtr; C;

 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3Pick_GetType(pick: TQ3PickObject): LONGINT; C;
...
FUNCTION Q3Pick_GetPickDetailValidMask(pick: TQ3PickObject; index: LONGINT; VAR pickDetailValidMask: TQ3PickDetail): TQ3Status; C;
FUNCTION Q3Pick_GetPickDetailData(pick: TQ3PickObject; index: LONGINT; pickDetailValue: TQ3PickDetail; detailData: UNIV Ptr): TQ3Status; C;
 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3ShapePart_GetType(shapePartObject: TQ3ShapePartObject): LONGINT; C;
FUNCTION Q3MeshPart_GetType(meshPartObject: TQ3MeshPartObject): LONGINT; C;

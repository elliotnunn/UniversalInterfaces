...
TYPE
	TQ3ViewerObject						= Ptr;
	TQ3ViewerDrawingCallbackMethod = ProcPtr;  { FUNCTION TQ3ViewerDrawingCallbackMethod(theViewer: TQ3ViewerObject; data: UNIV Ptr): OSErr; C; }
 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3ViewerGetVersion(VAR majorRevision: LONGINT; VAR minorRevision: LONGINT): OSErr; C;
 ...
 **																			 **
 ****************************************************************************}
FUNCTION Q3ViewerGetReleaseVersion(VAR releaseRevision: LONGINT): OSErr; C;
...
FUNCTION Q3ViewerWriteData(theViewer: TQ3ViewerObject; data: Handle): LONGINT; C;
{*****************************************************************************
 **																			 **
...
FUNCTION Q3ViewerSetDimension(theViewer: TQ3ViewerObject; width: LONGINT; height: LONGINT): OSErr; C;
FUNCTION Q3ViewerGetDimension(theViewer: TQ3ViewerObject; VAR width: LONGINT; VAR height: LONGINT): OSErr; C;
{ 1.1 }
FUNCTION Q3ViewerGetMinimumDimension(theViewer: TQ3ViewerObject; VAR width: LONGINT; VAR height: LONGINT): OSErr; C;
{*****************************************************************************
 **																			 **
 **							Port related calls								 **
 **																			 **

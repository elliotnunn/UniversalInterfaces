...
CONST
	...
	conferenceDropAvail			= $00000080;					{  a call to TELDrop will drop this  }
	...
	numToConferenceRequired		= $00000400;					{  the number of CAs to be conferenced is  }
...
CONST
	...
	voiceDetected				= $00080000;					{  voice has been detected on this CA incase of  }
																{  an incoming call  }
...
FUNCTION TELChoose(VAR hTEL: TELHandle; where: Point; idleProc: TelephoneChooseIdleProcPtr): TELErr;
...
FUNCTION TELDNMsgHand(hTELDN: TELDNHandle; allDNs: BOOLEAN; eventMask: LONGINT; msgProc: TelephoneDNMsgProcPtr; globals: LONGINT): TELErr;
FUNCTION TELClrDNMsgHand(hTELDN: TELDNHandle; msgProc: TelephoneDNMsgProcPtr): TELErr;
...
FUNCTION TELCAMsgHand(hTELDN: TELDNHandle; eventMask: LONGINT; msgProc: TelephoneCAMsgProcPtr; globals: LONGINT): TELErr;
FUNCTION TELClrCAMsgHand(hTELDN: TELDNHandle; msgProc: TelephoneCAMsgProcPtr): TELErr;

...
FUNCTION TECGetTextEncodingFromInternetName(VAR textEncoding: TextEncoding; encodingName: ConstStr255Param): OSStatus;
...
FUNCTION TECCreateOneToManyConverterFromPath(VAR newEncodingConverter: TECObjectRef; {CONST}VAR inPath: TextEncoding; inEncodings: ItemCount; numOutputEncodings: ItemCount; {CONST}VAR outputEncodings: TextEncoding): OSStatus;

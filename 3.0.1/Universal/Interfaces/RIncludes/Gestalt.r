...
#define gestaltALMAttr 					'trip'				/*  Apple Location Manager attributes (see also gestaltALMVers)  */
#define gestaltALMPresent 				0					/*  bit true if ALM is available  */
#define gestaltALMHasSFLocation 		1					/*  bit true if Put/Get/Merge Location calls are implmented  */
...
#define gestaltALMVers 					'walk'				/*  Apple Location Manager version (see also gestaltALMAttr)  */

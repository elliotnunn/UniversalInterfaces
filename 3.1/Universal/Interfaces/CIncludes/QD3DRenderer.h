...
enum TQ3HiddenSurfaceRemovalMode {
	kQ3HiddenSurfaceRemovalMode_None = 0,
	kQ3HiddenSurfaceRemovalMode_Shallow = 1,
	kQ3HiddenSurfaceRemovalMode_Deep = 2
};
typedef enum TQ3HiddenSurfaceRemovalMode TQ3HiddenSurfaceRemovalMode;

...
*/
	...
	EXTERN_API( ComponentResult  ) ADD_AVPANEL_BASENAME(Install) (AVPANEL_GLOBALS() ADD_AVPANEL_COMMA DialogPtr  dialog, short  itemOffset);

	EXTERN_API( ComponentResult  ) ADD_AVPANEL_BASENAME(Event) (AVPANEL_GLOBALS() ADD_AVPANEL_COMMA DialogPtr  dialog, short  itemOffset, EventRecord * event, short * itemHit, Boolean * handled);

	EXTERN_API( ComponentResult  ) ADD_AVPANEL_BASENAME(Item) (AVPANEL_GLOBALS() ADD_AVPANEL_COMMA DialogPtr  dialog, short  itemOffset, short  itemNum);

	EXTERN_API( ComponentResult  ) ADD_AVPANEL_BASENAME(Remove) (AVPANEL_GLOBALS() ADD_AVPANEL_COMMA DialogPtr  dialog, short  itemOffset);

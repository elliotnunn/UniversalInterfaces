...
PROCEDURE SetMenuItemHotKey(menu: MenuHandle; itemID: INTEGER; hotKey: ByteParameter; flags: LONGINT); C;
...
FUNCTION GetMenuFont(menu: MenuHandle; VAR outFontID: SInt16; VAR outFontSize: UInt16): OSStatus;
FUNCTION SetMenuFont(menu: MenuHandle; inFontID: SInt16; inFontSize: UInt16): OSStatus;
FUNCTION GetMenuExcludesMarkColumn(menu: MenuHandle): BOOLEAN;
FUNCTION SetMenuExcludesMarkColumn(menu: MenuHandle; excludesMark: BOOLEAN): OSStatus;
{——————————————————————————————————————————————————————————————————————————————————————}
{	• Menu Item Insertion	 															}
{——————————————————————————————————————————————————————————————————————————————————————}
...
FUNCTION AppendMenuItemText(menu: MenuHandle; inString: Str255): OSStatus;
FUNCTION InsertMenuItemText(menu: MenuHandle; inString: Str255; afterItem: UInt16): OSStatus;
{——————————————————————————————————————————————————————————————————————————————————————}
{	• Menu Events				 														}
{——————————————————————————————————————————————————————————————————————————————————————}
...
PROCEDURE EnableMenuItem(theMenu: MenuHandle; item: UInt16);
PROCEDURE DisableMenuItem(theMenu: MenuHandle; item: UInt16);
FUNCTION IsMenuItemEnabled(menu: MenuHandle; item: UInt16): BOOLEAN;
PROCEDURE EnableMenuItemIcon(theMenu: MenuHandle; item: UInt16);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $303C, $0019, $A825;
	{$ENDC}
PROCEDURE DisableMenuItemIcon(theMenu: MenuHandle; item: UInt16);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $303C, $0020, $A825;
	{$ENDC}
FUNCTION IsMenuItemIconEnabled(menu: MenuHandle; item: UInt16): BOOLEAN;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
...
{——————————————————————————————————————————————————————————————————————————————————————}
FUNCTION GetMenuItemProperty(menu: MenuHandle; item: UInt16; propertyCreator: OSType; propertyTag: OSType; bufferSize: UInt32; VAR actualSize: UInt32; propertyBuffer: UNIV Ptr): OSStatus;
FUNCTION GetMenuItemPropertySize(menu: MenuHandle; item: UInt16; propertyCreator: OSType; propertyTag: OSType; VAR size: UInt32): OSStatus;
FUNCTION SetMenuItemProperty(menu: MenuHandle; item: UInt16; propertyCreator: OSType; propertyTag: OSType; propertySize: UInt32; propertyData: UNIV Ptr): OSStatus;
FUNCTION RemoveMenuItemProperty(menu: MenuHandle; item: UInt16; propertyCreator: OSType; propertyTag: OSType): OSStatus;

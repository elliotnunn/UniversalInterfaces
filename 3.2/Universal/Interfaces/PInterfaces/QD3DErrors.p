...
CONST
	...
	kQ3ErrorUnsupportedPixelDepth = {TQ3Error}-28388;			{  Controller Errors  }
	kQ3ErrorController			= {TQ3Error}-28387;				{  Tracker Errors  }
	kQ3ErrorTracker				= {TQ3Error}-28386;				{  Another OS Error  }
	kQ3ErrorWin32Error			= {TQ3Error}-28385;				{  Object Errors  }
	kQ3ErrorTypeAlreadyExistsAndHasSubclasses = {TQ3Error}-28384;
	kQ3ErrorTypeAlreadyExistsAndOtherClassesDependOnIt = {TQ3Error}-28383;
	kQ3ErrorTypeAlreadyExistsAndHasObjectInstances = {TQ3Error}-28382; {  submit loop errors: if you ever get one of these check the previous }
																{  error posted, it may be kQ3ErrorOutOfMemory.  If so you *may* be able }
																{  to recover by freeing up some memory and trying again }
	kQ3ErrorPickingLoopFailed	= {TQ3Error}-28381;
	kQ3ErrorRenderingLoopFailed	= {TQ3Error}-28380;
	kQ3ErrorWritingLoopFailed	= {TQ3Error}-28379;
	kQ3ErrorBoundingLoopFailed	= {TQ3Error}-28378;
...
CONST
	...
	kQ3WarningParameterOutOfRange = {TQ3Warning}-28266;			{  Extension Warnings  }
	kQ3WarningExtensionNotLoading = {TQ3Warning}-28265;			{  Object Warnings  }
	kQ3WarningTypeAlreadyRegistered = {TQ3Warning}-28264;
	kQ3WarningTypeSameVersionAlreadyRegistered = {TQ3Warning}-28263;
	kQ3WarningTypeNewerVersionAlreadyRegistered = {TQ3Warning}-28262; {  Invalid Group Object  }
	kQ3WarningInvalidObjectInGroupMetafile = {TQ3Warning}-28261;
...
CONST
	...
	kQ3NoticeDataAlreadyEmpty	= {TQ3Notice}-28100;
	kQ3NoticeMethodNotSupported	= {TQ3Notice}-28099;
	kQ3NoticeObjectAlreadySet	= {TQ3Notice}-28098;
	kQ3NoticeParameterOutOfRange = {TQ3Notice}-28097;
	kQ3NoticeFileAliasWasChanged = {TQ3Notice}-28096;
	...
	kQ3NoticeMeshEdgeIsNotBoundary = {TQ3Notice}-28092;
	kQ3NoticeDrawContextNotSetUsingInternalDefaults = {TQ3Notice}-28091;
	kQ3NoticeInvalidAttenuationTypeUsingInternalDefaults = {TQ3Notice}-28090;
	kQ3NoticeBrightnessGreaterThanOne = {TQ3Notice}-28089;
	kQ3NoticeScaleContainsZeroEntries = {TQ3Notice}-28088;
	kQ3NoticeSystemAlreadyInitialized = {TQ3Notice}-28087;
	kQ3NoticeViewSyncCalledAgain = {TQ3Notice}-28086;
	kQ3NoticeFileCancelled		= {TQ3Notice}-28085;


TYPE
{$IFC TYPED_FUNCTION_POINTERS}
	TQ3ErrorMethod = PROCEDURE(firstError: TQ3Error; lastError: TQ3Error; reference: LONGINT); C;
{$ELSEC}
	TQ3ErrorMethod = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	TQ3WarningMethod = PROCEDURE(firstWarning: TQ3Warning; lastWarning: TQ3Warning; reference: LONGINT); C;
{$ELSEC}
	TQ3WarningMethod = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	TQ3NoticeMethod = PROCEDURE(firstNotice: TQ3Notice; lastNotice: TQ3Notice; reference: LONGINT); C;
{$ELSEC}
	TQ3NoticeMethod = ProcPtr;
{$ENDC}

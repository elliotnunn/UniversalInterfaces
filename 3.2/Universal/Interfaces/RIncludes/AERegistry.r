...
#define pFTPKind 						'kind'
															...
															/*  Scheme enumerations  */
#define eScheme 						'esch'
#define eurlHTTP 						'http'
#define eurlHTTPS 						'htps'
#define eurlFTP 						'ftp '
#define eurlMail 						'mail'
#define eurlFile 						'file'
#define eurlGopher 						'gphr'
#define eurlTelnet 						'tlnt'
#define eurlNews 						'news'
#define eurlSNews 						'snws'
#define eurlNNTP 						'nntp'

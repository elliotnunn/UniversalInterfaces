...
/*	Preliminary Rez interfaces for InputSprocket.
 *
 ...
 *	This obviously won't do for use in Rez, so the ISpLib 1.2.1 has been
 ...
 *	applications that use this template WILL REQUIRE INPUTSPROCKET 1.2.1
...
keyCode:
		unsigned hex integer noKey = 0x8000,				/* virtual key code		*/
			...
			f5Key = 0x0060, f6Key = 0x0061, f7Key = 0x0063, f8Key = 0x0064, f9Key = 0x0065,
			f10Key = 0x006D, f10Key = 0x006D, f11Key = 0x0067, f12Key = 0x006F, 

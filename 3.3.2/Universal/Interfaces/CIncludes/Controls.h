...
NewControl                      (WindowRef              owningWindow,
...
EXTERN_API( void )
UpdateControls                  (WindowRef              theWindow,
...
/*——————————————————————————————————————————————————————————————————————————————————————*/
EXTERN_API( OSErr )
GetKeyboardFocus                (WindowRef              inWindow,
                                 ControlRef *           outControl)                         THREEWORDINLINE(0x303C, 0x000D, 0xAA73);

EXTERN_API( OSErr )
SetKeyboardFocus                (WindowRef              inWindow,
...
EXTERN_API_C( ControlRef )
newcontrol                      (WindowRef              theWindow,
                                 const Rect *           boundsRect,
                                 const char *           title,
                                 Boolean                visible,
                                 short                  value,

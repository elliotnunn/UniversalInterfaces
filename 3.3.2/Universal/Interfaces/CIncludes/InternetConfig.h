...
/************************************************************************************************
  keys
 ************************************************************************************************/
#define kICReservedKey "\pkICReservedKey"   /* key reserved for use by Internet Config  */
...
EXTERN_API( OSStatus )
ICFindConfigFile                (ICInstance             inst,
                                 short                  count,
...
/* [b5] 
   ...
   */
EXTERN_API( OSStatus )
ICFindUserConfigFile            (ICInstance             inst,
...
/* [r1] [b5] 
   ...
   */
EXTERN_API( OSStatus )
ICGeneralFindConfigFile         (ICInstance             inst,
                                 Boolean                searchPrefs,
                                 Boolean                canCreate,
                                 short                  count,
...
#if CALL_NOT_IN_CARBON
EXTERN_API( OSStatus )
ICGetConfigReference            (ICInstance             inst,
...
/* [r2] [c1] [b3] 
   ...
   */
EXTERN_API( OSStatus )
ICSetConfigReference            (ICInstance             inst,
 ...
 * wrong.  Please read the documentation for more details.
  */
EXTERN_API( OSStatus )
ICSpecifyConfigFile             (ICInstance             inst,
...
#if CALL_NOT_IN_CARBON
EXTERN_API( OSStatus )
ICDefaultFileName               (ICInstance             inst,
...
/* [c3] [b3] 
   ...
   */
EXTERN_API( OSStatus )
ICGetComponentInstance          (ICInstance             inst,
...
/* [r3] [c2] [b3] 
   ...
   */
EXTERN_API( OSStatus )
ICGetMappingInterruptSafe       (ICInstance             inst,
                                 Ptr *                  mappingPref,
...
/* [r3] [c2] [b3] 
   ...
   */
EXTERN_API( OSStatus )
ICGetSeedInterruptSafe          (ICInstance             inst,
...
/* ***** Starting Up and Shutting Down *****  */
EXTERN_API( OSStatus )
ICCStart                        (ComponentInstance *    inst,
                                 OSType                 creator);
...
EXTERN_API( OSStatus )
ICCGetVersion                   (ComponentInstance      inst,
                                 long                   whichVersion,
                                 UInt32 *               version)                            FIVEWORDINLINE(0x2F3C, 0x0008, 0x0032, 0x7000, 0xA82A);
...
/* ***** Specifying a Configuration *****  */
EXTERN_API( OSStatus )
ICCFindConfigFile               (ComponentInstance      inst,
                                 short                  count,
                                 ICDirSpecArrayPtr      folders)                            FIVEWORDINLINE(0x2F3C, 0x0006, 0x0002, 0x7000, 0xA82A);

/* See comment for ICCFindConfigFile.  */
EXTERN_API( OSStatus )
ICCFindUserConfigFile           (ComponentInstance      inst,
                                 ICDirSpec *            where)                              FIVEWORDINLINE(0x2F3C, 0x0004, 0x000E, 0x7000, 0xA82A);

/* See comment for ICCFindUserConfigFile.  */
EXTERN_API( OSStatus )
ICCGeneralFindConfigFile        (ComponentInstance      inst,
                                 Boolean                searchPrefs,
                                 Boolean                canCreate,
                                 short                  count,
                                 ICDirSpecArrayPtr      folders)                            FIVEWORDINLINE(0x2F3C, 0x000A, 0x001E, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCGetConfigName                (ComponentInstance      inst,
                                 Boolean                longname,
                                 Str255                 name)                               FIVEWORDINLINE(0x2F3C, 0x0006, 0x0023, 0x7000, 0xA82A);

/* See comment for ICCGetConfigName.  */
EXTERN_API( OSStatus )
ICCGetConfigReference           (ComponentInstance      inst,
                                 ICConfigRefHandle      ref)                                FIVEWORDINLINE(0x2F3C, 0x0004, 0x001F, 0x7000, 0xA82A);

/* See comment for ICCGetConfigReference.  */
EXTERN_API( OSStatus )
ICCSetConfigReference           (ComponentInstance      inst,
                                 ICConfigRefHandle      ref,
                                 long                   flags)                              FIVEWORDINLINE(0x2F3C, 0x0008, 0x0020, 0x7000, 0xA82A);
 ...
 * wrong.  Please read the documentation for more details.
  */
EXTERN_API( OSStatus )
ICCSpecifyConfigFile            (ComponentInstance      inst,
                                 FSSpec *               config)                             FIVEWORDINLINE(0x2F3C, 0x0004, 0x0003, 0x7000, 0xA82A);
...
/* ***** Getting Information *****  */
EXTERN_API( OSStatus )
ICCGetSeed                      (ComponentInstance      inst,
                                 long *                 seed)                               FIVEWORDINLINE(0x2F3C, 0x0004, 0x0004, 0x7000, 0xA82A);

/* See comment for ICCGetSeed.  */
EXTERN_API( OSStatus )
ICCGetPerm                      (ComponentInstance      inst,
                                 ICPerm *               perm)                               FIVEWORDINLINE(0x2F3C, 0x0004, 0x000D, 0x7000, 0xA82A);

/* See comment for ICCGetPerm.  */
EXTERN_API( OSStatus )
ICCDefaultFileName              (ComponentInstance      inst,
                                 Str63                  name)                               FIVEWORDINLINE(0x2F3C, 0x0004, 0x000B, 0x7000, 0xA82A);
...
/* ***** Reading and Writing Preferences *****  */
EXTERN_API( OSStatus )
ICCBegin                        (ComponentInstance      inst,
                                 ICPerm                 perm)                               FIVEWORDINLINE(0x2F3C, 0x0002, 0x0005, 0x7000, 0xA82A);

/* See comment for ICCBegin.  */
EXTERN_API( OSStatus )
ICCGetPref                      (ComponentInstance      inst,
                                 ConstStr255Param       key,
                                 ICAttr *               attr,
                                 Ptr                    buf,
                                 long *                 size)                               FIVEWORDINLINE(0x2F3C, 0x0010, 0x0006, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCSetPref                      (ComponentInstance      inst,
                                 ConstStr255Param       key,
                                 ICAttr                 attr,
                                 Ptr                    buf,
                                 long                   size)                               FIVEWORDINLINE(0x2F3C, 0x0010, 0x0007, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCFindPrefHandle               (ComponentInstance      inst,
                                 ConstStr255Param       key,
                                 ICAttr *               attr,
                                 Handle                 prefh)                              FIVEWORDINLINE(0x2F3C, 0x000C, 0x0024, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCGetPrefHandle                (ComponentInstance      inst,
                                 ConstStr255Param       key,
                                 ICAttr *               attr,
                                 Handle *               prefh)                              FIVEWORDINLINE(0x2F3C, 0x000C, 0x001A, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCSetPrefHandle                (ComponentInstance      inst,
                                 ConstStr255Param       key,
                                 ICAttr                 attr,
                                 Handle                 prefh)                              FIVEWORDINLINE(0x2F3C, 0x000C, 0x001B, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCCountPref                    (ComponentInstance      inst,
                                 long *                 count)                              FIVEWORDINLINE(0x2F3C, 0x0004, 0x0008, 0x7000, 0xA82A);

/* See comment for ICCCountPref.  */
EXTERN_API( OSStatus )
ICCGetIndPref                   (ComponentInstance      inst,
                                 long                   index,
                                 Str255                 key)                                FIVEWORDINLINE(0x2F3C, 0x0008, 0x0009, 0x7000, 0xA82A);

/* See comment for ICCGetIndPref.  */
EXTERN_API( OSStatus )
ICCDeletePref                   (ComponentInstance      inst,
                                 ConstStr255Param       key)                                FIVEWORDINLINE(0x2F3C, 0x0004, 0x000C, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCGetDefaultPref               (ComponentInstance      inst,
                                 ConstStr255Param       key,
                                 Handle                 prefH)                              FIVEWORDINLINE(0x2F3C, 0x0008, 0x0031, 0x7000, 0xA82A);
...
/* ***** User Interface Stuff *****  */
EXTERN_API( OSStatus )
ICCEditPreferences              (ComponentInstance      inst,
                                 ConstStr255Param       key)                                FIVEWORDINLINE(0x2F3C, 0x0004, 0x000F, 0x7000, 0xA82A);

/* See comment for ICCEditPreferences.  */
/* ***** URL Handling *****  */
EXTERN_API( OSStatus )
ICCLaunchURL                    (ComponentInstance      inst,
                                 ConstStr255Param       hint,
                                 Ptr                    data,
                                 long                   len,
                                 long *                 selStart,
...
EXTERN_API( OSStatus )
ICCParseURL                     (ComponentInstance      inst,
                                 ConstStr255Param       hint,
                                 Ptr                    data,
                                 long                   len,
                                 long *                 selStart,
...
EXTERN_API( OSStatus )
ICCCreateGURLEvent              (ComponentInstance      inst,
                                 OSType                 helperCreator,
                                 Handle                 urlH,
                                 AppleEvent *           theEvent)                           FIVEWORDINLINE(0x2F3C, 0x000C, 0x0033, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCSendGURLEvent                (ComponentInstance      inst,
                                 AppleEvent *           theEvent)                           FIVEWORDINLINE(0x2F3C, 0x0004, 0x0034, 0x7000, 0xA82A);
 ...
 * ----- High Level Routines -----
  */
EXTERN_API( OSStatus )
ICCMapFilename                  (ComponentInstance      inst,
                                 ConstStr255Param       filename,
                                 ICMapEntry *           entry)                              FIVEWORDINLINE(0x2F3C, 0x0008, 0x0018, 0x7000, 0xA82A);

/* See comment for ICCMapFilename.  */
EXTERN_API( OSStatus )
ICCMapTypeCreator               (ComponentInstance      inst,
                                 OSType                 fType,
                                 OSType                 fCreator,
                                 ConstStr255Param       filename,
                                 ICMapEntry *           entry)                              FIVEWORDINLINE(0x2F3C, 0x0010, 0x0019, 0x7000, 0xA82A);
...
/* ----- Mid Level Routines -----  */
EXTERN_API( OSStatus )
ICCMapEntriesFilename           (ComponentInstance      inst,
                                 Handle                 entries,
                                 ConstStr255Param       filename,
                                 ICMapEntry *           entry)                              FIVEWORDINLINE(0x2F3C, 0x000C, 0x001C, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCMapEntriesTypeCreator        (ComponentInstance      inst,
                                 Handle                 entries,
                                 OSType                 fType,
                                 OSType                 fCreator,
                                 ConstStr255Param       filename,
...
/* ----- Low Level Routines -----  */
EXTERN_API( OSStatus )
ICCCountMapEntries              (ComponentInstance      inst,
                                 Handle                 entries,
                                 long *                 count)                              FIVEWORDINLINE(0x2F3C, 0x0008, 0x0012, 0x7000, 0xA82A);

/* See comment for ICCCountMapEntries.  */
EXTERN_API( OSStatus )
ICCGetIndMapEntry               (ComponentInstance      inst,
                                 Handle                 entries,
                                 long                   index,
                                 long *                 pos,
                                 ICMapEntry *           entry)                              FIVEWORDINLINE(0x2F3C, 0x0010, 0x0013, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCGetMapEntry                  (ComponentInstance      inst,
                                 Handle                 entries,
                                 long                   pos,
                                 ICMapEntry *           entry)                              FIVEWORDINLINE(0x2F3C, 0x000C, 0x0014, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCSetMapEntry                  (ComponentInstance      inst,
                                 Handle                 entries,
                                 long                   pos,
...
EXTERN_API( OSStatus )
ICCDeleteMapEntry               (ComponentInstance      inst,
                                 Handle                 entries,
                                 long                   pos)                                FIVEWORDINLINE(0x2F3C, 0x0008, 0x0016, 0x7000, 0xA82A);

/* See comment for ICCDeleteMapEntry.  */
EXTERN_API( OSStatus )
ICCAddMapEntry                  (ComponentInstance      inst,
                                 Handle                 entries,
...
/* ***** Profile Management Routines *****  */
EXTERN_API( OSStatus )
ICCGetCurrentProfile            (ComponentInstance      inst,
                                 ICProfileID *          currentID)                          FIVEWORDINLINE(0x2F3C, 0x0004, 0x0025, 0x7000, 0xA82A);

/* See comment for ICCGetCurrentProfile.  */
EXTERN_API( OSStatus )
ICCSetCurrentProfile            (ComponentInstance      inst,
                                 ICProfileID            newID)                              FIVEWORDINLINE(0x2F3C, 0x0004, 0x0026, 0x7000, 0xA82A);

/* See comment for ICCSetCurrentProfile.  */
EXTERN_API( OSStatus )
ICCCountProfiles                (ComponentInstance      inst,
                                 long *                 count)                              FIVEWORDINLINE(0x2F3C, 0x0004, 0x0027, 0x7000, 0xA82A);

/* See comment for ICCCountProfiles.  */
EXTERN_API( OSStatus )
ICCGetIndProfile                (ComponentInstance      inst,
                                 long                   index,
                                 ICProfileID *          thisID)                             FIVEWORDINLINE(0x2F3C, 0x0008, 0x0028, 0x7000, 0xA82A);

/* See comment for ICCGetIndProfile.  */
EXTERN_API( OSStatus )
ICCGetProfileName               (ComponentInstance      inst,
                                 ICProfileID            thisID,
                                 Str255                 name)                               FIVEWORDINLINE(0x2F3C, 0x0008, 0x0029, 0x7000, 0xA82A);

/* See comment for ICCGetProfileName.  */
EXTERN_API( OSStatus )
ICCSetProfileName               (ComponentInstance      inst,
                                 ICProfileID            thisID,
                                 ConstStr255Param       name)                               FIVEWORDINLINE(0x2F3C, 0x0008, 0x002A, 0x7000, 0xA82A);

/* See comment for ICCSetProfileName.  */
EXTERN_API( OSStatus )
ICCAddProfile                   (ComponentInstance      inst,
                                 ICProfileID            prototypeID,
                                 ICProfileID *          newID)                              FIVEWORDINLINE(0x2F3C, 0x0008, 0x002B, 0x7000, 0xA82A);

/* See comment for ICCAddProfile.  */
EXTERN_API( OSStatus )
ICCDeleteProfile                (ComponentInstance      inst,
                                 ICProfileID            thisID)                             FIVEWORDINLINE(0x2F3C, 0x0004, 0x002C, 0x7000, 0xA82A);
...
EXTERN_API( OSStatus )
ICCGetMappingInterruptSafe      (ComponentInstance      inst,
                                 Ptr *                  mappingPref,
                                 long *                 mappingPrefSize)                    FIVEWORDINLINE(0x2F3C, 0x0008, 0x002E, 0x7000, 0xA82A);

/* See comment for ICCGetMappingInterruptSafe.  */
EXTERN_API( OSStatus )
ICCGetSeedInterruptSafe         (ComponentInstance      inst,
                                 long *                 seed)                               FIVEWORDINLINE(0x2F3C, 0x0004, 0x0030, 0x7000, 0xA82A);

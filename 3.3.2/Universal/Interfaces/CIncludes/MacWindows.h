...
enum {
    ...
    kDesktopWindowClass         = 7L,                           /* desktop window (usually only one of these exists) - OS X only*/
...
typedef UInt32                          WindowGrowSides;
enum {
...
enum {
    ...
    kWindowSupportsSetGrowImageRegion = (1 << 13),              /* window definition will calculate the grow image region manually.*/

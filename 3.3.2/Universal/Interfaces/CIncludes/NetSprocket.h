...
/*
    NetSprocket is not in CarbonLib 1.0.2.  But, it is possible to still use 
    NetSprocket on OS 8/9 in a CarbonLib based application, by setting  
    CALL_IN_SPOCKETS_BUT_NOT_IN_CARBON to 1 on the command line or in a prefix
    file, weaklinking with NetSpocketLib, and testing for its existence 
    at runtime.
*/

...
#if (TARGET_API_MAC_CARBON || TARGET_API_MAC_OSX || TARGET_OS_UNIX || TARGET_OS_WIN32)
...
#endif  /* (TARGET_API_MAC_CARBON || TARGET_API_MAC_OSX || TARGET_OS_UNIX || TARGET_OS_WIN32) */

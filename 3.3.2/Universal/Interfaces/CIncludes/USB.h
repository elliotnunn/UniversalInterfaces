...
EXTERN_API_C( OSStatus )
USBGetBandwidthAvailableByReference (USBReference       ref,
                                 UInt32 *               avail);
...
EXTERN_API_C( OSStatus )
USBExpertStatusLevel            (UInt32                 level,
                                 USBDeviceRef           ref,
                                 StringPtr              status,
                                 UInt32                 value);
...
EXTERN_API_C( OSStatus )
USBAddDriverForFSSpec           (USBReference           reference,
                                 FSSpec *               fileSpec);
...
EXTERN_API_C( OSStatus )
USBReferenceToRegEntry          (RegEntryID *           parentEntry,

...
FUNCTION NewSIGStatusUPP(userRoutine: SIGStatusProcPtr): SIGStatusUPP; { old name was NewSIGStatusProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}

PROCEDURE DisposeSIGStatusUPP(userUPP: SIGStatusUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}

FUNCTION InvokeSIGStatusUPP(userRoutine: SIGStatusUPP): BOOLEAN; { old name was CallSIGStatusProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}

...
{   Menu Manager Gestalt (Mac OS 8.5 and later) }
	...
	gestaltMenuMgrPresent		= $00000001;					{  NOTE: this is a bit mask, where all other Gestalt constants of this nature  }
	...
	gestaltMenuMgrPresentMask	= $00000001;					{  bit mask  }
	gestaltMenuMgrAquaLayoutMask = $00000002;					{  bit mask  }
...
{$ENDC}  {OLDROUTINENAMES}
	...
	gestaltAllegroQDText		= $0100;						{  starting with 8.2 (?)  }

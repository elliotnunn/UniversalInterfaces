 ...
 ***********************************************************************************************}
CONST
    kICReservedKey = 'kICReservedKey';  (* key reserved for use by Internet Config *)
    ...
    kICHelperDesc = 'HelperDesc•';  (* PString -- description for URL scheme *)
    kICHelperList = 'HelperList•';  (* ICAppSpecList -- list of common helpers for URL schemes *)
    kICIRCHost = 'IRCHost';  (* PString -- host.domain, Internet Relay Chat server *)
    ...
    kICNTPHost = 'NTPHost';  (* PString -- host.domain, Network Time Protocol (NTP) *)
    ...
    kICWebReadColor = '646F6777•WebReadColor';  (* RGBColor -- colour for read links *)
    kICWebSearchPagePrefs = 'WebSearchPagePrefs';  (* PString -- URL, users default search page *)
    kICWebTextColor = 'WebTextColor';  (* RGBColor -- colour for normal text *)
    kICWebUnderlineLinks = '646F6777•WebUnderlineLinks';  (* Boolean -- whether to underline links *)
    kICWebUnreadColor = '646F6777•WebUnreadColor';  (* RGBColor -- colour for unread links *)

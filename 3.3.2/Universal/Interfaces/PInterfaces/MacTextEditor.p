...

{
  ********************************************************************************************
    ...
    Input:
        ...
        iEvent:             The event record.  Usually a NULL event.
    Output:
...

{
  *******************************************************************************************************
    ...
    Input:
        iTXNObject:             current document
        oContinuousFlags:   Bits which can be examined to see which if any
  ...
  ****************************************************************************************************************
    ...
    Input:
        ...
        iIsActualWindow:    Let the library know if the GWorldPtr is actually
                            a WindowPtr or actually a GWorldPtr.  This is important
...

{
  *********************************************************************************************************************
    ...
    Output:
        ...
        oFontMenuHandle:    The font menu. Can be NULL.
  *********************************************************************************************************************
}
FUNCTION TXNGetFontMenuHandle(iTXNFontMenuObject: TXNFontMenuObject; VAR oFontMenuHandle: MenuHandle): OSStatus; C;
...

{
  **********************************************************************************************************************
    ...
    Input:
        ...
        iTXNFontMenuObject: The font menu object obtained from TXNGetFontMenuHandle.

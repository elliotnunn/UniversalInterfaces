...
CONST
	...
	kLastFlashTrackAction		= 10244;
	kFirstMovieTrackAction		= 11264;
	kLastMovieTrackAction		= 11265;
	kFirstAction				= 1024;
	kLastAction					= 11265;
...
{  QTEvent types  }
	...
	kQTEventIdle				= 'idle';
	kQTEventKey					= 'key ';						{  qtevent.where.h = key, qtevent.where.v = modifiers, qtEvent.flags = scanCode  }
...
TYPE
	...
	QTParamFetchPreviePtr				= ^QTParamFetchPreviewRecord;

...

{
   ...
   and is used to access the kOTCfgATalkGeneralPref preference.
	...
	OTCfgATalkGeneral = RECORD
		...
		fPort:					OTPortRef;								{  a reference to the port over which this configuration is running }
...
TYPE
	...
	OTCfgIRGeneral = RECORD
		fVersion:				UInt32;									{  must be 0 }
		fPortRef:				OTPortRef;								{  reference to IR port }
...

{
   ...
   list of name servers.
	...
	OTCfgTCPDNSServersList = RECORD
		fCount:					UInt16;
		fAddressesList:			ARRAY [0..0] OF InetHost;
	END;
...
TYPE
	...
	OTCfgRemoteLogOptions = RECORD
		...
		reserved:				ARRAY [0..3] OF UInt32;					{  must be zero }
	END;
...
TYPE
	...
	OTCfgRemoteServerPort = RECORD
		...
		localIPAddress:			InetHost;								{  IP address to offer to client }
	END;

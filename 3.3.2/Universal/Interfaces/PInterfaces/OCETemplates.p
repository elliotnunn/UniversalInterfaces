...
{$IFC TYPED_FUNCTION_POINTERS}
	DETCallBackProcPtr = FUNCTION(callBlockPtr: DETCallBlockPtr; callBackBlockPtr: DETCallBackBlockPtr): OSErr;
{$ELSEC}
...
FUNCTION NewDETCallBackUPP(userRoutine: DETCallBackProcPtr): DETCallBackUPP; { old name was NewDETCallBackProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}

PROCEDURE DisposeDETCallBackUPP(userUPP: DETCallBackUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}

FUNCTION InvokeDETCallBackUPP(callBlockPtr: DETCallBlockPtr; callBackBlockPtr: DETCallBackBlockPtr; userRoutine: DETCallBackUPP): OSErr; { old name was CallDETCallBackProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}
...
FUNCTION NewDETCallUPP(userRoutine: DETCallProcPtr): DETCallUPP; { old name was NewDETCallProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}

PROCEDURE DisposeDETCallUPP(userUPP: DETCallUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}

FUNCTION InvokeDETCallUPP(callBlockPtr: DETCallBlockPtr; userRoutine: DETCallUPP): OSErr; { old name was CallDETCallProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}
{$ENDC}  {CALL_NOT_IN_CARBON}

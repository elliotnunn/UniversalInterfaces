{
     ...
     Copyright:  © 1993-2000 by Apple Computer, Inc. and Mentat Inc., all rights reserved.
...
FUNCTION OTAsyncOpenInternetServices(cfig: OTConfigurationRef; oflag: OTOpenFlags; proc: OTNotifyProcPtr; contextPtr: UNIV Ptr): OSStatus;
{$ENDC}  {CALL_NOT_IN_CARBON}
...
{$IFC CALL_NOT_IN_CARBON }
FUNCTION OTAsyncOpenAppleTalkServices(cfig: OTConfigurationRef; flags: OTOpenFlags; proc: OTNotifyProcPtr; contextPtr: UNIV Ptr): OSStatus;

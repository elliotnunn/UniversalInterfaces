...
{$IFC TYPED_FUNCTION_POINTERS}
	PItemProcPtr = PROCEDURE(theDialog: DialogPtr; item: INTEGER);
{$ELSEC}
...
PROCEDURE InvokePItemUPP(theDialog: DialogPtr; item: INTEGER; userRoutine: PItemUPP); { old name was CallPItemProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}

...
FUNCTION NewMusicMIDIReadHookUPP(userRoutine: MusicMIDIReadHookProcPtr): MusicMIDIReadHookUPP; { old name was NewMusicMIDIReadHookProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}
...
PROCEDURE DisposeMusicMIDIReadHookUPP(userUPP: MusicMIDIReadHookUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}
...
FUNCTION InvokeMusicMIDIReadHookUPP(VAR mp: MusicMIDIPacket; myRefCon: LONGINT; userRoutine: MusicMIDIReadHookUPP): ComponentResult; { old name was CallMusicMIDIReadHookProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}

...
FUNCTION QTSPrefsFindProxyByType(proxyType: OSType; flags: UInt32; flagsMask: UInt32; VAR proxyHndl: QTSProxyPrefPtr; VAR count: SInt16): OSErr; C;
FUNCTION QTSPrefsAddConnectionSetting(protocol: OSType; portID: SInt32; flags: UInt32; seed: UInt32): OSErr; C;
FUNCTION QTSPrefsFindConnectionByType(protocol: OSType; flags: UInt32; flagsMask: UInt32; VAR connectionHndl: QTSTransportPrefPtr; VAR count: SInt16): OSErr; C;
FUNCTION QTSPrefsGetActiveConnection(protocol: OSType; VAR connectInfo: QTSTransportPref): OSErr; C;
FUNCTION QTSPrefsGetNoProxyURLs(VAR noProxyHndl: QTSNoProxyPrefPtr): OSErr; C;

...
typedef CALLBACK_API( void , ThemeButtonDrawWithContextProcPtr )(const Rect *bounds, ThemeButtonKind kind, const ThemeButtonDrawInfo *info, UInt32 userData, SInt16 depth, Boolean isColorDev, void *context);
...
typedef STACK_UPP_TYPE(ThemeButtonDrawWithContextProcPtr) 		ThemeButtonDrawWithContextUPP;
...
typedef STACK_UPP_TYPE(ThemeIteratorProcPtr) 					ThemeIteratorUPP;
	...
	EXTERN_API(ThemeButtonDrawWithContextUPP)
	NewThemeButtonDrawWithContextUPP    (ThemeButtonDrawWithContextProcPtr userRoutine);
	...
	EXTERN_API(void)
	DisposeThemeButtonDrawWithContextUPP    (ThemeButtonDrawWithContextUPP userUPP);
	...
	EXTERN_API(void)
	InvokeThemeButtonDrawWithContextUPP    (const Rect *	bounds,
									ThemeButtonKind			kind,
									const ThemeButtonDrawInfo * info,
									UInt32					userData,
									SInt16					depth,
									Boolean					isColorDev,
									void *					context,
									ThemeButtonDrawWithContextUPP userUPP);
	...
	enum { uppThemeButtonDrawWithContextProcInfo = 0x000DBEC0 }; 	/* pascal no_return_value Func(4_bytes, 2_bytes, 4_bytes, 4_bytes, 2_bytes, 1_byte, 4_bytes) */
	...
	#define NewThemeButtonDrawWithContextUPP(userRoutine) 			(ThemeButtonDrawWithContextUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeButtonDrawWithContextProcInfo, GetCurrentArchitecture())
	...
	#define DisposeThemeButtonDrawWithContextUPP(userUPP) 			DisposeRoutineDescriptor(userUPP)
	...
	#define InvokeThemeButtonDrawWithContextUPP(bounds, kind, info, userData, depth, isColorDev, context, userUPP)  CALL_SEVEN_PARAMETER_UPP((userUPP), uppThemeButtonDrawWithContextProcInfo, (bounds), (kind), (info), (userData), (depth), (isColorDev), (context))
...
#define NewThemeButtonDrawWithContextProc(userRoutine) 			NewThemeButtonDrawWithContextUPP(userRoutine)
...
#define CallThemeButtonDrawWithContextProc(userRoutine, bounds, kind, info, userData, depth, isColorDev, context) InvokeThemeButtonDrawWithContextUPP(bounds, kind, info, userData, depth, isColorDev, context, userRoutine)
...
typedef CALLBACK_API( void , MenuTitleDrawingWithContextProcPtr )(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice, SInt32 inUserData, void *context);
...
typedef CALLBACK_API( void , MenuItemDrawingWithContextProcPtr )(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice, SInt32 inUserData, void *context);
typedef STACK_UPP_TYPE(MenuTitleDrawingProcPtr) 				MenuTitleDrawingUPP;
typedef STACK_UPP_TYPE(MenuTitleDrawingWithContextProcPtr) 		MenuTitleDrawingWithContextUPP;
typedef STACK_UPP_TYPE(MenuItemDrawingProcPtr) 					MenuItemDrawingUPP;
typedef STACK_UPP_TYPE(MenuItemDrawingWithContextProcPtr) 		MenuItemDrawingWithContextUPP;
#if OPAQUE_UPP_TYPES
	EXTERN_API(MenuTitleDrawingUPP)
	NewMenuTitleDrawingUPP		   (MenuTitleDrawingProcPtr	userRoutine);

	EXTERN_API(MenuTitleDrawingWithContextUPP)
	NewMenuTitleDrawingWithContextUPP    (MenuTitleDrawingWithContextProcPtr userRoutine);

	EXTERN_API(MenuItemDrawingUPP)
	NewMenuItemDrawingUPP		   (MenuItemDrawingProcPtr	userRoutine);

	EXTERN_API(MenuItemDrawingWithContextUPP)
	NewMenuItemDrawingWithContextUPP    (MenuItemDrawingWithContextProcPtr userRoutine);

	EXTERN_API(void)
	DisposeMenuTitleDrawingUPP	   (MenuTitleDrawingUPP		userUPP);

	EXTERN_API(void)
	DisposeMenuTitleDrawingWithContextUPP    (MenuTitleDrawingWithContextUPP userUPP);

	EXTERN_API(void)
	DisposeMenuItemDrawingUPP	   (MenuItemDrawingUPP		userUPP);

	EXTERN_API(void)
	DisposeMenuItemDrawingWithContextUPP    (MenuItemDrawingWithContextUPP userUPP);
	...
	EXTERN_API(void)
	InvokeMenuTitleDrawingWithContextUPP    (const Rect *	inBounds,
									SInt16					inDepth,
									Boolean					inIsColorDevice,
									SInt32					inUserData,
									void *					context,
									MenuTitleDrawingWithContextUPP userUPP);
	...
	EXTERN_API(void)
	InvokeMenuItemDrawingWithContextUPP    (const Rect *	inBounds,
									SInt16					inDepth,
									Boolean					inIsColorDevice,
									SInt32					inUserData,
									void *					context,
									MenuItemDrawingWithContextUPP userUPP);

#else
	enum { uppMenuTitleDrawingProcInfo = 0x000036C0 }; 				/* pascal no_return_value Func(4_bytes, 2_bytes, 1_byte, 4_bytes) */
	enum { uppMenuTitleDrawingWithContextProcInfo = 0x0000F6C0 }; 	/* pascal no_return_value Func(4_bytes, 2_bytes, 1_byte, 4_bytes, 4_bytes) */
	enum { uppMenuItemDrawingProcInfo = 0x000036C0 }; 				/* pascal no_return_value Func(4_bytes, 2_bytes, 1_byte, 4_bytes) */
	enum { uppMenuItemDrawingWithContextProcInfo = 0x0000F6C0 }; 	/* pascal no_return_value Func(4_bytes, 2_bytes, 1_byte, 4_bytes, 4_bytes) */
	...
	#define NewMenuTitleDrawingWithContextUPP(userRoutine) 			(MenuTitleDrawingWithContextUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuTitleDrawingWithContextProcInfo, GetCurrentArchitecture())
	...
	#define NewMenuItemDrawingWithContextUPP(userRoutine) 			(MenuItemDrawingWithContextUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuItemDrawingWithContextProcInfo, GetCurrentArchitecture())
	#define DisposeMenuTitleDrawingUPP(userUPP) 					DisposeRoutineDescriptor(userUPP)
	#define DisposeMenuTitleDrawingWithContextUPP(userUPP) 			DisposeRoutineDescriptor(userUPP)
	#define DisposeMenuItemDrawingUPP(userUPP) 						DisposeRoutineDescriptor(userUPP)
	#define DisposeMenuItemDrawingWithContextUPP(userUPP) 			DisposeRoutineDescriptor(userUPP)
	...
	#define InvokeMenuTitleDrawingWithContextUPP(inBounds, inDepth, inIsColorDevice, inUserData, context, userUPP)  CALL_FIVE_PARAMETER_UPP((userUPP), uppMenuTitleDrawingWithContextProcInfo, (inBounds), (inDepth), (inIsColorDevice), (inUserData), (context))
	...
	#define InvokeMenuItemDrawingWithContextUPP(inBounds, inDepth, inIsColorDevice, inUserData, context, userUPP)  CALL_FIVE_PARAMETER_UPP((userUPP), uppMenuItemDrawingWithContextProcInfo, (inBounds), (inDepth), (inIsColorDevice), (inUserData), (context))
#endif
/* support for pre-Carbon UPP routines: NewXXXProc and CallXXXProc */
#define NewMenuTitleDrawingProc(userRoutine) 					NewMenuTitleDrawingUPP(userRoutine)
#define NewMenuTitleDrawingWithContextProc(userRoutine) 		NewMenuTitleDrawingWithContextUPP(userRoutine)
#define NewMenuItemDrawingProc(userRoutine) 					NewMenuItemDrawingUPP(userRoutine)
#define NewMenuItemDrawingWithContextProc(userRoutine) 			NewMenuItemDrawingWithContextUPP(userRoutine)
...
#define CallMenuTitleDrawingWithContextProc(userRoutine, inBounds, inDepth, inIsColorDevice, inUserData, context) InvokeMenuTitleDrawingWithContextUPP(inBounds, inDepth, inIsColorDevice, inUserData, context, userRoutine)
...
#define CallMenuItemDrawingWithContextProc(userRoutine, inBounds, inDepth, inIsColorDevice, inUserData, context) InvokeMenuItemDrawingWithContextUPP(inBounds, inDepth, inIsColorDevice, inUserData, context, userRoutine)
/*——————————————————————————————————————————————————————————————————————————————————*/
...
EXTERN_API( OSStatus )
DrawThemeMenuBarBackgroundWithContext (const Rect *		inBounds,
								 ThemeMenuBarState 		inState,
								 UInt32 				inAttributes,
								 void *					inContext) /* can be NULL */;
...
EXTERN_API( OSStatus )
DrawThemeMenuTitleWithContext	(const Rect *			inMenuBarRect,
								 const Rect *			inTitleRect,
								 ThemeMenuState 		inState,
								 UInt32 				inAttributes,
								 MenuTitleDrawingWithContextUPP  inTitleProc, /* can be NULL */
								 UInt32 				inTitleData,
								 void *					inContext) /* can be NULL */;
...
EXTERN_API( OSStatus )
DrawThemeMenuItemWithContext	(const Rect *			inMenuRect,
								 const Rect *			inItemRect,
								 SInt16 				inVirtualMenuTop,
								 SInt16 				inVirtualMenuBottom,
								 ThemeMenuState 		inState,
								 ThemeMenuItemType 		inItemType,
								 MenuItemDrawingWithContextUPP  inDrawProc, /* can be NULL */
								 UInt32 				inUserData,
								 void *					inContext) /* can be NULL */;
...
EXTERN_API( OSStatus )
DrawThemeMenuSeparatorWithContext (const Rect *			inItemRect,
...
EXTERN_API( OSStatus )
DrawThemeButtonWithContext		(const Rect *			inBounds,
								 ThemeButtonKind 		inKind,
								 const ThemeButtonDrawInfo * inNewInfo,
								 const ThemeButtonDrawInfo * inPrevInfo, /* can be NULL */
								 ThemeEraseUPP 			inEraseProc, /* can be NULL */
								 ThemeButtonDrawWithContextUPP  inLabelProc, /* can be NULL */
								 UInt32 				inUserData,
...
EXTERN_API( OSStatus )
DrawThemeTickMarkWithContext	(const Rect *			bounds,
								 ThemeDrawState 		state,
								 void *					context);

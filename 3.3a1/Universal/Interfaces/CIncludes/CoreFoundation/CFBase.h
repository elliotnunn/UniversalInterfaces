...
#pragma import on
	...
	#pragma option enum=int
		...
		#define PRAGMA_ENUM_PACK__COREFOUNDATION_CFBASE__
	#endif
...
#else
/* The __CFRangeMake() function is not available in Sonata;
   will have to do without this convenience. */
...
#elif defined(PRAGMA_ENUM_PACK__COREFOUNDATION_CFBASE__)
	#pragma options(pack_enums)
#endif

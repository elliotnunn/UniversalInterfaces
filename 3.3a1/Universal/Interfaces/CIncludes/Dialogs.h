...
struct AlertStdAlertParamRec {
	...
	ConstStr255Param 				defaultText;				/* Text for button in OK position */
	ConstStr255Param 				cancelText;					/* Text for button in cancel position */
	ConstStr255Param 				otherText;					/* Text for button in left position */

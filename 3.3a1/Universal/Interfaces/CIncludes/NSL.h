...
enum {
																/* Error codes*/
	kNSLNavigationAPIErrorBase	= -4200,						/* UNABLE TO INITIALIZE THE MANAGER!!!!!*/
																/* DO NOT CONTINUE!!!!*/
	kNSLInitializationFailed	= kNSLNavigationAPIErrorBase,	/* General NSL error codes.*/
	...
	kNSLSomePluginsFailedToLoad	= -4177,						/* (one or more plugins failed to load, but at*/
																/* least one did load; this error isn't fatal)*/
	...
	kNSLLastAndMeaningLessItemInNSLEnum = -4169
};

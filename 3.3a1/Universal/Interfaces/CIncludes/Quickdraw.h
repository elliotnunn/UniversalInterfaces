...
#if !(TARGET_CARBON || TARGET_OS_UNIX || TARGET_OS_WIN32)
#define OLDPIXMAPSTRUCT 1
#else
#define OLDPIXMAPSTRUCT 0
#endif  /* !(TARGET_CARBON || TARGET_OS_UNIX || TARGET_OS_WIN32) */
...
#if !(TARGET_CARBON || TARGET_OS_UNIX || TARGET_OS_WIN32) || (NeXT && ppc)
...
EXTERN_API( OSStatus )
QDGetDirtyRegion				(CGrafPtr 				port,
								 RgnHandle 				rgn);

EXTERN_API( OSStatus )
QDSetDirtyRegion				(CGrafPtr 				port,
								 RgnHandle 				rgn);

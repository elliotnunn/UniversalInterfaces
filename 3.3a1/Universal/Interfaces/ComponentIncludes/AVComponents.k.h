...
*/
#ifndef ___AVCOMPONENTS_K__
#define ___AVCOMPONENTS_K__
...
*/
	...
	EXTERN_API( ComponentResult  ) ADD_AVPORT_BASENAME(GetIndexedDisplayProfile) (AVPORT_GLOBALS() ADD_AVPORT_COMMA UInt32  reserved, UInt32  profileIndex, UInt32  profileSeed, void * indexedProfile);

...
*************************************************************************}
	...
	kASSelectFlushTerminology	= $110E;
...
FUNCTION OSAFlushTerminology(scriptingComponent: ComponentInstance; modeFlags: LONGINT): OSAError;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2F3C, $0004, $110E, $7000, $A82A;
	{$ENDC}
{ Errors:
	   errOSASystemError		operation failed
	}

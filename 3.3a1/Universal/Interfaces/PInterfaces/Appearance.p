...
CONST
	...
	kThemeWindowHasA			= $0200;
	kThemeWindowHasB			= $0400;
...
{$IFC TYPED_FUNCTION_POINTERS}
	ThemeButtonDrawWithContextProcPtr = PROCEDURE({CONST}VAR bounds: Rect; kind: ThemeButtonKind; {CONST}VAR info: ThemeButtonDrawInfo; userData: UInt32; depth: SInt16; isColorDev: BOOLEAN; context: UNIV Ptr);
{$ELSEC}
	ThemeButtonDrawWithContextProcPtr = ProcPtr;
{$ENDC}
...
{$ENDC}
	...
	ThemeButtonDrawWithContextUPP = UniversalProcPtr;
...
CONST
	...
	uppThemeButtonDrawWithContextProcInfo = $000DBEC0;
...
FUNCTION NewThemeButtonDrawWithContextUPP(userRoutine: ThemeButtonDrawWithContextProcPtr): ThemeButtonDrawWithContextUPP; { old name was NewThemeButtonDrawWithContextProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}
...
PROCEDURE DisposeThemeButtonDrawWithContextUPP(userUPP: ThemeButtonDrawWithContextUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}
...
PROCEDURE InvokeThemeButtonDrawWithContextUPP({CONST}VAR bounds: Rect; kind: ThemeButtonKind; {CONST}VAR info: ThemeButtonDrawInfo; userData: UInt32; depth: SInt16; isColorDev: BOOLEAN; context: UNIV Ptr; userRoutine: ThemeButtonDrawWithContextUPP); { old name was CallThemeButtonDrawWithContextProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}
...
{$IFC TYPED_FUNCTION_POINTERS}
	MenuTitleDrawingWithContextProcPtr = PROCEDURE({CONST}VAR inBounds: Rect; inDepth: SInt16; inIsColorDevice: BOOLEAN; inUserData: SInt32; context: UNIV Ptr);
{$ELSEC}
	MenuTitleDrawingWithContextProcPtr = ProcPtr;
{$ENDC}
...
{$IFC TYPED_FUNCTION_POINTERS}
	MenuItemDrawingWithContextProcPtr = PROCEDURE({CONST}VAR inBounds: Rect; inDepth: SInt16; inIsColorDevice: BOOLEAN; inUserData: SInt32; context: UNIV Ptr);
{$ELSEC}
	MenuItemDrawingWithContextProcPtr = ProcPtr;
{$ENDC}

	MenuTitleDrawingUPP = UniversalProcPtr;
	MenuTitleDrawingWithContextUPP = UniversalProcPtr;
	MenuItemDrawingUPP = UniversalProcPtr;
	MenuItemDrawingWithContextUPP = UniversalProcPtr;

CONST
	uppMenuTitleDrawingProcInfo = $000036C0;
	uppMenuTitleDrawingWithContextProcInfo = $0000F6C0;
	uppMenuItemDrawingProcInfo = $000036C0;
	uppMenuItemDrawingWithContextProcInfo = $0000F6C0;
...
FUNCTION NewMenuTitleDrawingWithContextUPP(userRoutine: MenuTitleDrawingWithContextProcPtr): MenuTitleDrawingWithContextUPP; { old name was NewMenuTitleDrawingWithContextProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}
...
FUNCTION NewMenuItemDrawingWithContextUPP(userRoutine: MenuItemDrawingWithContextProcPtr): MenuItemDrawingWithContextUPP; { old name was NewMenuItemDrawingWithContextProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2E9F;
	{$ENDC}
...
PROCEDURE DisposeMenuTitleDrawingWithContextUPP(userUPP: MenuTitleDrawingWithContextUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}
...
PROCEDURE DisposeMenuItemDrawingWithContextUPP(userUPP: MenuItemDrawingWithContextUPP);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $584F;
	{$ENDC}
...
PROCEDURE InvokeMenuTitleDrawingWithContextUPP({CONST}VAR inBounds: Rect; inDepth: SInt16; inIsColorDevice: BOOLEAN; inUserData: SInt32; context: UNIV Ptr; userRoutine: MenuTitleDrawingWithContextUPP); { old name was CallMenuTitleDrawingWithContextProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}
...
PROCEDURE InvokeMenuItemDrawingWithContextUPP({CONST}VAR inBounds: Rect; inDepth: SInt16; inIsColorDevice: BOOLEAN; inUserData: SInt32; context: UNIV Ptr; userRoutine: MenuItemDrawingWithContextUPP); { old name was CallMenuItemDrawingWithContextProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}
{——————————————————————————————————————————————————————————————————————————————————}
...
FUNCTION DrawThemeMenuBarBackground({CONST}VAR inBounds: Rect; inState: ThemeMenuBarState; inAttributes: UInt32): OSStatus;
	...
	{$ENDC}
FUNCTION DrawThemeMenuBarBackgroundWithContext({CONST}VAR inBounds: Rect; inState: ThemeMenuBarState; inAttributes: UInt32; inContext: UNIV Ptr): OSStatus;
FUNCTION DrawThemeMenuTitle({CONST}VAR inMenuBarRect: Rect; {CONST}VAR inTitleRect: Rect; inState: ThemeMenuState; inAttributes: UInt32; inTitleProc: MenuTitleDrawingUPP; inTitleData: UInt32): OSStatus;
	...
	{$ENDC}
FUNCTION DrawThemeMenuTitleWithContext({CONST}VAR inMenuBarRect: Rect; {CONST}VAR inTitleRect: Rect; inState: ThemeMenuState; inAttributes: UInt32; inTitleProc: MenuTitleDrawingWithContextUPP; inTitleData: UInt32; inContext: UNIV Ptr): OSStatus;
...
FUNCTION DrawThemeMenuItem({CONST}VAR inMenuRect: Rect; {CONST}VAR inItemRect: Rect; inVirtualMenuTop: SInt16; inVirtualMenuBottom: SInt16; inState: ThemeMenuState; inItemType: ThemeMenuItemType; inDrawProc: MenuItemDrawingUPP; inUserData: UInt32): OSStatus;
	...
	{$ENDC}
FUNCTION DrawThemeMenuItemWithContext({CONST}VAR inMenuRect: Rect; {CONST}VAR inItemRect: Rect; inVirtualMenuTop: SInt16; inVirtualMenuBottom: SInt16; inState: ThemeMenuState; inItemType: ThemeMenuItemType; inDrawProc: MenuItemDrawingWithContextUPP; inUserData: UInt32; inContext: UNIV Ptr): OSStatus;
FUNCTION DrawThemeMenuSeparator({CONST}VAR inItemRect: Rect): OSStatus;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $303C, $001E, $AA74;
	{$ENDC}
FUNCTION DrawThemeMenuSeparatorWithContext({CONST}VAR inItemRect: Rect; {CONST}VAR inMenuRect: Rect; inItemType: ThemeMenuItemType; inContext: UNIV Ptr): OSStatus;
...
FUNCTION DrawThemeButtonWithContext({CONST}VAR inBounds: Rect; inKind: ThemeButtonKind; {CONST}VAR inNewInfo: ThemeButtonDrawInfo; inPrevInfo: {Const}ThemeButtonDrawInfoPtr; inEraseProc: ThemeEraseUPP; inLabelProc: ThemeButtonDrawWithContextUPP; inUserData: UInt32; context: UNIV Ptr): OSStatus;
...
FUNCTION DrawThemeTickMarkWithContext({CONST}VAR bounds: Rect; state: ThemeDrawState; context: UNIV Ptr): OSStatus;

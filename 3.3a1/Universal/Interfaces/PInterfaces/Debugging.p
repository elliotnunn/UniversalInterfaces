...
PROCEDURE DebugAssert(componentSignature: OSType; options: UInt32; assertionString: CStringPtr; exceptionString: CStringPtr; errorString: CStringPtr; fileName: CStringPtr; lineNumber: LONGINT; value: UNIV Ptr);
...
TYPE
{$IFC TYPED_FUNCTION_POINTERS}
	DebugAssertOutputHandlerProcPtr = PROCEDURE(componentSignature: OSType; options: UInt32; assertionString: CStringPtr; exceptionString: CStringPtr; errorString: CStringPtr; fileName: CStringPtr; lineNumber: LONGINT; value: UNIV Ptr; outputMsg: Str255);
{$ELSEC}
...
PROCEDURE InvokeDebugAssertOutputHandlerUPP(componentSignature: OSType; options: UInt32; assertionString: CStringPtr; exceptionString: CStringPtr; errorString: CStringPtr; fileName: CStringPtr; lineNumber: LONGINT; value: UNIV Ptr; outputMsg: Str255; userRoutine: DebugAssertOutputHandlerUPP); { old name was CallDebugAssertOutputHandlerProc }
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $205F, $4E90;
	{$ENDC}
{

 ...
 * may be set in these selectCode values.
	...
	kFSMSetForeignPrivs			= $0061;						{  The HFSPlus	API SelectCodes	 }
	kFSMGetVolumeInfo			= $001D;
	kFSMSetVolumeInfo			= $001E;
	kFSMReadFork				= $0051;
	kFSMWriteFork				= $0052;
	...
	kFSMCloseIterator			= $005B;
	kFSMGetCatalogInfoBulk		= $005C;
	kFSMCatalogSearch			= $005D;
	kFSMMakeFSRef				= $006E;
	kFSMCreateFileUnicode		= $0070;
	kFSMCreateDirUnicode		= $0071;
	kFSMDeleteObject			= $0072;
	kFSMMoveObject				= $0073;

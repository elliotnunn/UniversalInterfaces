...
{$IFC TYPED_FUNCTION_POINTERS}
	GetIPIOCompletionProcPtr = PROCEDURE(VAR iopb: GetAddrParamBlock); C;
{$ELSEC}
...
{$IFC TYPED_FUNCTION_POINTERS}
	IPIOCompletionProcPtr = PROCEDURE(VAR iopb: ICMPParamBlock); C;
{$ELSEC}
...
TYPE
	...
	TCPiopbPtr = ^TCPiopb;
{$IFC TYPED_FUNCTION_POINTERS}
	TCPIOCompletionProcPtr = PROCEDURE(VAR iopb: TCPiopb); C;
{$ELSEC}
...
{ for receive and buffer return calls }
	...
	UDPiopbPtr = ^UDPiopb;
{$IFC TYPED_FUNCTION_POINTERS}
	UDPIOCompletionProcPtr = PROCEDURE(VAR iopb: UDPiopb); C;
{$ELSEC}
...
PROCEDURE InvokeGetIPIOCompletionUPP(VAR iopb: GetAddrParamBlock; userRoutine: GetIPIOCompletionUPP); { old name was CallGetIPIOCompletionProc }

PROCEDURE InvokeIPIOCompletionUPP(VAR iopb: ICMPParamBlock; userRoutine: IPIOCompletionUPP); { old name was CallIPIOCompletionProc }
...
PROCEDURE InvokeTCPIOCompletionUPP(VAR iopb: TCPiopb; userRoutine: TCPIOCompletionUPP); { old name was CallTCPIOCompletionProc }
...
PROCEDURE InvokeUDPIOCompletionUPP(VAR iopb: UDPiopb; userRoutine: UDPIOCompletionUPP); { old name was CallUDPIOCompletionProc }

...
{$IFC TYPED_FUNCTION_POINTERS}
	closep_t = FUNCTION(VAR q: queue; foo: OTInt32; VAR cred: cred_t): OTInt32; C;
{$ELSEC}
	closep_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	old_closep_t = FUNCTION(VAR q: queue): OTInt32; C;
{$ELSEC}
	old_closep_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	openp_t = FUNCTION(VAR q: queue; VAR dev: dev_t; foo: OTInt32; bar: OTInt32; VAR cred: cred_t): OTInt32; C;
{$ELSEC}
	openp_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	openOld_t = FUNCTION(VAR q: queue; dev: dev_t; foo: OTInt32; bar: OTInt32): OTInt32; C;
{$ELSEC}
	openOld_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	old_openp_t = FUNCTION(VAR q: queue; dev: dev_t; foo: OTInt32; bar: OTInt32): OTInt32; C;
{$ELSEC}
	old_openp_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	closeOld_t = FUNCTION(VAR q: queue): OTInt32; C;
{$ELSEC}
	closeOld_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	putp_t = FUNCTION(VAR q: queue; VAR mp: msgb): OTInt32; C;
{$ELSEC}
	putp_t = ProcPtr;
{$ENDC}

{$IFC TYPED_FUNCTION_POINTERS}
	srvp_t = FUNCTION(VAR q: queue): OTInt32; C;
{$ELSEC}
	srvp_t = ProcPtr;
{$ENDC}
...
TYPE
	linkblkPtr = ^linkblk;
	linkblk = RECORD
		l_qtop:					queuePtr;								{  lowest level write queue of upper stream  }
		l_qbot:					queuePtr;								{  highest level write queue of lower stream  }

...
enum {
  kAppleshareAutomountServerAliasesFolderType = FOUR_CHAR_CODE('srvƒ'), /* Appleshare puts volumes to automount inside this folder. */
  kPreMacOS91ApplicationsFolderType = FOUR_CHAR_CODE('åpps'), /* The "Applications" folder, pre Mac OS 9.1 */
  kPreMacOS91InstallerLogsFolderType = FOUR_CHAR_CODE('îlgf'), /* The "Installer Logs" folder, pre Mac OS 9.1 */
  kPreMacOS91AssistantsFolderType = FOUR_CHAR_CODE('åstƒ'), /* The "Assistants" folder, pre Mac OS 9.1 */
  kPreMacOS91UtilitiesFolderType = FOUR_CHAR_CODE('ütiƒ'), /* The "Utilities" folder, pre Mac OS 9.1 */
  kPreMacOS91AppleExtrasFolderType = FOUR_CHAR_CODE('åexƒ'), /* The "Apple Extras" folder, pre Mac OS 9.1 */
  kPreMacOS91MacOSReadMesFolderType = FOUR_CHAR_CODE('µorƒ'), /* The "Mac OS ReadMes" folder, pre Mac OS 9.1 */
  kPreMacOS91InternetFolderType = FOUR_CHAR_CODE('întƒ'), /* The "Internet" folder, pre Mac OS 9.1 */
  kPreMacOS91AutomountedServersFolderType = FOUR_CHAR_CODE('ßrvƒ'), /* The "Servers" folder, pre Mac OS 9.1 */
  kPreMacOS91StationeryFolderType = FOUR_CHAR_CODE('ødst') /* The "Stationery" folder, pre Mac OS 9.1 */
};

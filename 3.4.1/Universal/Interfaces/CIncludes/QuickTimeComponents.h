...
#define XML_ADD_ELEMENT_NS(elementName,nameSpaceID)     elementID   =   xmlpc_GLUE2(element_,elementName);  XMLParseAddElement(xmlParser, #elementName, nameSpaceID, &elementID, 0)
...
#define XML_ADD_COMPLEX_ELEMENT_NS(elementName,elemID,nameSpaceID)     elementID   =   xmlpc_GLUE2(element_,elemID);       XMLParseAddElement(xmlParser, #elementName, nameSpaceID, &elementID, 0)
...
#define XML_ADD_ATTRIBUTE_NS(attrName,nameSpaceID)     attributeID =   xmlpc_GLUE2(attr_,attrName);        XMLParseAddAttribute(xmlParser, elementID, nameSpaceID, #attrName, &attributeID);
...
#define XML_ADD_COMPLEX_ATTRIBUTE_NS(attrName,attrID,nameSpaceID)  attributeID =   xmlpc_GLUE2(attr_,attrID);      XMLParseAddAttribute(xmlParser, elementID, nameSpaceID, #attrName, &attributeID);
...
#define XML_ADD_ATTRIBUTE_AND_VALUE_NS(attrName,valueKind,valueKindInfo,nameSpaceID)   attributeID =   xmlpc_GLUE2(attr_,attrName);        XMLParseAddAttributeAndValue(xmlParser, elementID, nameSpaceID, #attrName, &attributeID, valueKind, valueKindInfo);
...
#define XML_ADD_COMPLEX_ATTRIBUTE_AND_VALUE_NS(attrName,attrID,valueKind,valueKindInfo,nameSpaceID)        attributeID =   xmlpc_GLUE2(attr_,attrID);      XMLParseAddAttributeAndValue(xmlParser, elementID, nameSpaceID, #attrName, &attributeID, valueKind, valueKindInfo);

...
*/
	...
	EXTERN_API( OSAError  ) ADD_OSA_BASENAME(DebuggerCountVariables) (OSA_GLOBALS() ADD_OSA_COMMA OSADebugSessionRef  inSession, OSADebugCallFrameRef  inCallFrame, OSALocalOrGlobal  inWhichSet, long * outVariableCount);
	...
	enum {
		...
		uppOSADebuggerCountVariablesProcInfo = 0x0000FFF0
	};

...
CONST
	...
	kATSLineIgnoreFontLeading	= $00000400;					{  specifies that any leading value specified by a font will be ignored  }
	kATSLineAppleReserved		= $FFFFF800;					{  these bits are reserved by Apple and will result in a invalid value error if attemped to set  }

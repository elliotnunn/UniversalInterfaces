...
FUNCTION AVLLockTree(tree: AVLTreePtr): OSErr;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $303C, $020A, $AA80;
	{$ENDC}
...
FUNCTION AVLUnlockTree(tree: AVLTreePtr): OSErr;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $303C, $020B, $AA80;
	{$ENDC}
...
FUNCTION AVLCheckTree(tree: AVLTreePtr): OSErr;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $303C, $020C, $AA80;
	{$ENDC}

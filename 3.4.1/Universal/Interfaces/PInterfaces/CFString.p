...
FUNCTION CFStringCreateWithBytes(alloc: CFAllocatorRef; bytes: UNIV Ptr; numBytes: CFIndex; encoding: CFStringEncoding; isExternalRepresentation: BOOLEAN): CFStringRef; C;

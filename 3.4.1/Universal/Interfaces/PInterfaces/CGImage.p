...
FUNCTION CGImageCreateWithJPEGDataProvider(source: CGDataProviderRef; {CONST}VAR decode: Single; shouldInterpolate: LONGINT; intent: CGColorRenderingIntent): CGImageRef; C;

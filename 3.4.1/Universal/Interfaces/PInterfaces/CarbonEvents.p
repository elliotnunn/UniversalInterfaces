{
     ...
     Version:    Technology: CarbonLib 1.5
...
FUNCTION GetCFRunLoopFromEventLoop(inEventLoop: EventLoopRef): CFTypeRef; C;
...
FUNCTION IsMouseCoalescingEnabled: BOOLEAN; C;
...
FUNCTION SetMouseCoalescingEnabled(inNewState: BOOLEAN; VAR outOldState: BOOLEAN): OSStatus; C;
...
CONST
	 ...
	 *    menu-related Carbon event.
																...
																{  menu location }
	kMenuContextMenuBar			= $01;							{  menu type }
	kMenuContextPullDown		= $0100;
	kMenuContextPopUp			= $0200;
	kMenuContextSubmenu			= $0400;						{  menu usage }
	kMenuContextMenuBarTracking	= $00010000;
	kMenuContextPopUpTracking	= $00020000;
	kMenuContextKeyMatching		= $00040000;
	kMenuContextMenuEnabling	= $00080000;
...
FUNCTION CreateTypeStringWithOSType(inType: OSType): CFStringRef;

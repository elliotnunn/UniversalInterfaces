...
FUNCTION CreateDisclosureTriangleControl(inWindow: WindowRef; {CONST}VAR inBoundsRect: Rect; inOrientation: ControlDisclosureTriangleOrientation; inTitle: CFStringRef; inInitialValue: SInt32; inDrawTitle: BOOLEAN; inAutoToggles: BOOLEAN; VAR outControl: ControlRef): OSStatus;
...
FUNCTION CreateEditTextControl(window: WindowRef; {CONST}VAR boundsRect: Rect; text: CFStringRef; isPassword: BOOLEAN; useInlineInput: BOOLEAN; style: {Const}ControlFontStyleRecPtr; VAR outControl: ControlRef): OSStatus;
...
FUNCTION CreateIconControl(inWindow: WindowRef; {CONST}VAR inBoundsRect: Rect; {CONST}VAR inIconContent: ControlButtonContentInfo; inDontTrack: BOOLEAN; VAR outControl: ControlRef): OSStatus;
...
{$ELSEC}
	DataBrowserItemNotificationWithItemProcPtr = ProcPtr;
{$ENDC}
...
{$IFC OPAQUE_UPP_TYPES}
	DataBrowserItemNotificationWithItemUPP = ^LONGINT; { an opaque UPP }
{$ELSEC}
	DataBrowserItemNotificationWithItemUPP = UniversalProcPtr;
{$ENDC}	
{$IFC OPAQUE_UPP_TYPES}
...
CONST
	...
	uppDataBrowserItemNotificationWithItemProcInfo = $00003FC0;
...
FUNCTION NewDataBrowserItemNotificationWithItemUPP(userRoutine: DataBrowserItemNotificationWithItemProcPtr): DataBrowserItemNotificationWithItemUPP;
{
...
PROCEDURE DisposeDataBrowserItemNotificationWithItemUPP(userUPP: DataBrowserItemNotificationWithItemUPP);
{
...
PROCEDURE InvokeDataBrowserItemNotificationWithItemUPP(browser: ControlRef; item: DataBrowserItemID; message: DataBrowserItemNotification; itemData: DataBrowserItemDataRef; userRoutine: DataBrowserItemNotificationWithItemUPP);
{
...
FUNCTION GetDataBrowserListViewHeaderDesc(browser: ControlRef; column: DataBrowserTableViewColumnID; VAR desc: DataBrowserListViewHeaderDesc): OSStatus;
...
FUNCTION SetDataBrowserListViewHeaderDesc(browser: ControlRef; column: DataBrowserTableViewColumnID; VAR desc: DataBrowserListViewHeaderDesc): OSStatus;
...
FUNCTION CreateEditUnicodeTextControl(window: WindowRef; {CONST}VAR boundsRect: Rect; text: CFStringRef; isPassword: BOOLEAN; style: {Const}ControlFontStyleRecPtr; VAR outControl: ControlRef): OSStatus;

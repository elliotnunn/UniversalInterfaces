...
PROCEDURE UpdateControls(inWindow: WindowRef; inUpdateRegion: RgnHandle);
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $A953;
	{$ENDC}
...
FUNCTION FindControlUnderMouse(inWhere: Point; inWindow: WindowRef; VAR outPart: ControlPartCode): ControlRef;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}

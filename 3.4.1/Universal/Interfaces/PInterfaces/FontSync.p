...
FUNCTION FNSProfileCreateWithFSRef({CONST}VAR iParentDirectory: FSRef; iNameLength: UniCharCount; {CONST}VAR iName: UniChar; iCreator: FourCharCode; iEstNumRefs: ItemCount; iDesiredVersion: FNSObjectVersion; VAR oProfile: FNSFontProfile): OSStatus; C;
...
FUNCTION FNSProfileOpenWithFSRef({CONST}VAR iFile: FSRef; iOpenForWrite: BOOLEAN; VAR oProfile: FNSFontProfile): OSStatus; C;

...
FUNCTION FMGetATSFontRefFromFont(iFont: FMFont): ATSFontRef; C;
...
FUNCTION FMGetATSFontFamilyRefFromFontFamily(iFamily: FMFontFamily): ATSFontFamilyRef; C;
...
FUNCTION FMGetFontFromATSFontRef(iFont: ATSFontRef): FMFont; C;
...
FUNCTION FMGetFontFamilyFromATSFontFamilyRef(iFamily: ATSFontFamilyRef): FMFontFamily; C;
...
FUNCTION FMGetFontContainerFromFontFamilyInstance(iFontFamily: FMFontFamily; iStyle: FMFontStyle; iFontSize: FMFontSize; VAR oFontContainer: FSSpec): OSStatus; C;
...
FUNCTION FMGetFontFamilyResource(iFontFamily: FMFontFamily; iFontStyle: FMFontStyle; iFontSize: FMFontSize; iBufferSize: ByteCount; ioBuffer: UNIV Ptr; VAR oSize: ByteCount): OSStatus; C;

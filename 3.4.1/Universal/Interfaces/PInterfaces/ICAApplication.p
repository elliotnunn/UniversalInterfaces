...
FUNCTION ICADownloadFile(VAR pb: ICADownloadFilePB; completion: ICACompletion): OSErr;
...
FUNCTION ICACopyObjectPropertyDictionary(VAR pb: ICACopyObjectPropertyDictionaryPB; completion: ICACompletion): OSErr;

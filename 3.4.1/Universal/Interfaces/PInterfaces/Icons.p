...
FUNCTION GetIconRefFromFileInfo({CONST}VAR inRef: FSRef; inFileNameLength: UniCharCount; {CONST}VAR inFileName: UniChar; inWhichInfo: FSCatalogInfoBitmap; inCatalogInfo: {Const}FSCatalogInfoPtr; inUsageFlags: IconServicesUsageFlags; VAR outIconRef: IconRef; VAR outLabel: SInt16): OSStatus;
...
FUNCTION PlotIconRefInContext(inContext: CGContextRef; {CONST}VAR inRect: CGRect; inAlign: IconAlignmentType; inTransform: IconTransformType; {CONST}VAR inLabelColor: RGBColor; inFlags: PlotIconRefFlags; inIconRef: IconRef): OSStatus;

...
FUNCTION GraphicsImportGetBaseDataOffsetAndSize64(ci: GraphicsImportComponent; VAR offset: wide; VAR size: wide): ComponentResult;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
...
TYPE
	...
	QTThumbnailSettings = RECORD
		enableThumbnail:		LONGINT;								{  a thoroughly padded Boolean }
		maxThumbnailWidth:		LONGINT;								{  set to zero to let someone else decide }
		maxThumbnailHeight:		LONGINT;								{  set to zero to let someone else decide }
	END;
...
FUNCTION GraphicsExportSetThumbnailEnabled(ci: GraphicsExportComponent; enableThumbnail: BOOLEAN; maxThumbnailWidth: LONGINT; maxThumbnailHeight: LONGINT): ComponentResult;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2F3C, $000A, $004C, $7000, $A82A;
	{$ENDC}
...
FUNCTION GraphicsExportGetThumbnailEnabled(ci: GraphicsExportComponent; VAR thumbnailEnabled: BOOLEAN; VAR maxThumbnailWidth: LONGINT; VAR maxThumbnailHeight: LONGINT): ComponentResult;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2F3C, $000C, $004D, $7000, $A82A;
	{$ENDC}
...
FUNCTION GraphicsExportSetExifEnabled(ci: GraphicsExportComponent; enableExif: BOOLEAN): ComponentResult;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $2F3C, $0002, $004E, $7000, $A82A;
	{$ENDC}
...
FUNCTION GraphicsExportGetExifEnabled(ci: GraphicsExportComponent; VAR exifEnabled: BOOLEAN): ComponentResult;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}

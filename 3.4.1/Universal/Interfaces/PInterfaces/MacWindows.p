...
CONST
	...
	kSheetAlertWindowClass		= 15;							{  sheet windows for alerts (available in Mac OS X after 10.0.x and CarbonLib 1.3) }
	kAltPlainWindowClass		= 16;							{  alternate plain window (in document layer) (available in Mac OS X after 10.0.x and CarbonLib 1.3) }
...
CONST
	...
	kWindowCloseBoxAttribute	= $00000001;
	kWindowHorizontalZoomAttribute = $00000002;
	kWindowVerticalZoomAttribute = $00000004;
	kWindowFullZoomAttribute	= $00000006;
	kWindowCollapseBoxAttribute	= $00000008;
	kWindowResizableAttribute	= $00000010;
	kWindowSideTitlebarAttribute = $00000020;
	kWindowToolbarButtonAttribute = $00000040;
	kWindowNoUpdatesAttribute	= $00010000;
	kWindowNoActivatesAttribute	= $00020000;
	kWindowOpaqueForEventsAttribute = $00040000;
	kWindowNoShadowAttribute	= $00200000;
	kWindowHideOnSuspendAttribute = $01000000;
	kWindowStandardHandlerAttribute = $02000000;
	kWindowHideOnFullScreenAttribute = $04000000;
	kWindowInWindowMenuAttribute = $08000000;
	kWindowLiveResizeAttribute	= $10000000;
	kWindowNoConstrainAttribute	= $80000000;
...
FUNCTION IsValidWindowClass(inClass: WindowClass): BOOLEAN; C;
...
FUNCTION GetAvailableWindowAttributes(inClass: WindowClass): WindowAttributes; C;
...
FUNCTION TransitionWindow(inWindow: WindowRef; inEffect: WindowTransitionEffect; inAction: WindowTransitionAction; inRect: {Const}RectPtr): OSStatus;
...
FUNCTION TransitionWindowAndParent(inWindow: WindowRef; inParentWindow: WindowRef; inEffect: WindowTransitionEffect; inAction: WindowTransitionAction; inRect: {Const}RectPtr): OSStatus;
...
CONST
	...
	kWindowConstrainUseTransitionWindow = $00000010;
...
CONST
	kWindowLatentVisibleFloater	= $01;
	kWindowLatentVisibleSuspend	= $02;
	kWindowLatentVisibleFullScreen = $04;
	kWindowLatentVisibleAppHidden = $08;
	kWindowLatentVisibleCollapsedOwner = $10;
	kWindowLatentVisibleCollapsedGroup = $20;
...
FUNCTION IsWindowLatentVisible(inWindow: WindowRef; VAR outLatentVisible: WindowLatentVisibility): BOOLEAN; C;
...
FUNCTION GetWindowStructurePort(inWindow: WindowRef): CGrafPtr;

...
FUNCTION CountMItems(theMenu: MenuRef): UInt16;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $A950;
	{$ENDC}
...
FUNCTION CountMenuItems(theMenu: MenuRef): UInt16;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $A950;
	{$ENDC}
...
FUNCTION EraseMenuBackground(inMenu: MenuRef; {CONST}VAR inEraseRect: Rect; inContext: CGContextRef): OSStatus; C;
...
FUNCTION ScrollMenuImage(inMenu: MenuRef; {CONST}VAR inScrollRect: Rect; inHScroll: LONGINT; inVScroll: LONGINT; inContext: CGContextRef): OSStatus; C;
...
FUNCTION CMPluginExamineContext(thisInstance: UNIV Ptr; {CONST}VAR inContext: AEDesc; VAR outCommandPairs: AEDescList): OSStatus; C;
...
FUNCTION CMPluginHandleSelection(thisInstance: UNIV Ptr; VAR inContext: AEDesc; inCommandID: SInt32): OSStatus; C;
...
PROCEDURE CMPluginPostMenuCleanup(thisInstance: UNIV Ptr); C;

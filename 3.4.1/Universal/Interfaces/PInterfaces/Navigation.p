...
FUNCTION NavCreateAskReviewDocumentsDialog({CONST}VAR inOptions: NavDialogCreationOptions; inDocumentCount: UInt32; inEventProc: NavEventUPP; inClientData: UNIV Ptr; VAR outDialog: NavDialogRef): OSStatus; C;
...
FUNCTION NavDialogGetSaveFileExtensionHidden(inPutFileDialog: NavDialogRef): BOOLEAN; C;
...
FUNCTION NavDialogSetSaveFileExtensionHidden(inPutFileDialog: NavDialogRef; inHidden: BOOLEAN): OSStatus; C;

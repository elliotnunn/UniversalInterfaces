...
FUNCTION IsProcessVisible({CONST}VAR psn: ProcessSerialNumber): BOOLEAN;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $3F3C, $005F, $A88F;
	{$ENDC}
...
FUNCTION ShowHideProcess({CONST}VAR psn: ProcessSerialNumber; visible: BOOLEAN): OSErr;
	{$IFC TARGET_OS_MAC AND TARGET_CPU_68K AND NOT TARGET_RT_MAC_CFM}
	INLINE $3F3C, $0060, $A88F;
	{$ENDC}

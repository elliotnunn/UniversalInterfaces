...
FUNCTION QDSwapPort(inNewPort: CGrafPtr; VAR outOldPort: CGrafPtr): BOOLEAN;
...
FUNCTION IsPortVisibleRegionEmpty(port: CGrafPtr): BOOLEAN;
...
FUNCTION IsPortClipRegionEmpty(port: CGrafPtr): BOOLEAN;
...
PROCEDURE SectRegionWithPortClipRegion(port: CGrafPtr; ioRegion: RgnHandle);
...
PROCEDURE SectRegionWithPortVisibleRegion(port: CGrafPtr; ioRegion: RgnHandle);
...
FUNCTION SwapPortPicSaveHandle(port: CGrafPtr; inPicSaveHdl: Handle): Handle;
...
PROCEDURE SetPortGrafProcs(port: CGrafPtr; procs: CQDProcsPtr);
...
PROCEDURE SetPortTextFont(port: CGrafPtr; txFont: INTEGER);
...
PROCEDURE SetPortTextSize(port: CGrafPtr; txSize: INTEGER);
...
PROCEDURE SetPortTextFace(port: CGrafPtr; face: StyleParameter);
...
PROCEDURE SetPortTextMode(port: CGrafPtr; mode: INTEGER);
...
FUNCTION QDAddRectToDirtyRegion(inPort: CGrafPtr; {CONST}VAR inBounds: Rect): OSStatus; C;
...
FUNCTION QDAddRegionToDirtyRegion(inPort: CGrafPtr; inRegion: RgnHandle): OSStatus; C;
...
FUNCTION QDBeginCGContext(inPort: CGrafPtr; VAR outContext: CGContextRef): OSStatus; C;
...
FUNCTION QDEndCGContext(inPort: CGrafPtr; VAR inoutContext: CGContextRef): OSStatus; C;
...
TYPE
	QDRegionBitsRef    = ^LONGINT; { an opaque 32-bit type }
...
FUNCTION QDSaveRegionBits(region: RgnHandle): QDRegionBitsRef;
...
FUNCTION QDRestoreRegionBits(region: RgnHandle; regionBits: QDRegionBitsRef): OSStatus;
...
FUNCTION QDDisposeRegionBits(regionBits: QDRegionBitsRef): OSStatus;

...
TYPE
	...
	{ kScrapClipboardScrap = CFSTR("com.apple.scrap.clipboard"); }
	{ kScrapFindScrap = CFSTR("com.apple.scrap.find"); }
...
CONST
	...
	kScrapClearNamedScrap		= $00000001;					{  aquire the named scrap, bumping and clearing }
...
FUNCTION GetScrapByName(name: CFStringRef; options: OptionBits; VAR scrap: ScrapRef): OSStatus;
...
FUNCTION ClearScrap(VAR inOutScrap: ScrapRef): OSStatus;

...
{$I+}
{$SETC TrapsIncludes := UsingIncludes}
...
CONST
	...
	_IconDispatch				= $ABC9;
	_ThreadDispatch				= $ABF2;
	_DictionaryDispatch			= $AA53;
	_DebugStr					= $ABFF;


																{  PPCToolbox  }
	_PPC						= $A0DD;						{  Alias Manager  }
	_AliasDispatch				= $A823;						{  Device Manager (some shared by the File Manager)  }
	_Open						= $A000;
	_Close						= $A001;
	_Read						= $A002;
	_Write						= $A003;
	...
	_HGetVol					= $A214;
	_HSetFLock					= $A241;
	_HRstFLock					= $A242;						{  dispatch trap for remaining File Manager (and Desktop Manager) calls }
	_FSDispatch					= $A060;
	_HFSDispatch				= $A260;						{  High level FSSpec calls  }
	...
	_SetGDevice					= $AA31;
	_GetGDevice					= $AA32;
	_DeviceLoop					= $ABCA;						{  Color Manager  }
	_Color2Index				= $AA33;
	_Index2Color				= $AA34;
	_InvertColor				= $AA35;
	_RealColor					= $AA36;
	...
	_DelComp					= $AA4D;
	_SetStdCProcs				= $AA4E;
	_StdOpcodeProc				= $ABF8;						{  Added to Toolbox for color  }
	_SetWinColor				= $AA41;
	_GetAuxWin					= $AA42;
	_SetCtlColor				= $AA43;
	...
	_GetWVariant				= $A80A;						{  Added to Menu Manager for color  }
	_DelMCEntries				= $AA60;
	...
	_GetMCEntry					= $AA64;
	_SetMCEntries				= $AA65;
	_MenuChoice					= $AA66;						{  Dialog Manager  }
	_ModalDialogMenuSetup		= $AA67;
	_DialogDispatch				= $AA68;						{  Font Manager  }
	...
	_SpeechRecognitionDispatch	= $AA56;
	_DockingDispatch			= $AA57;
	_MixedModeDispatch			= $AA59;						{  PowerPC Mac  }
	_CodeFragmentDispatch		= $AA5A;						{  PowerPC Mac  }
	_TranslationDispatch		= $ABFC;						{  Translation Manager  }
	_TextServicesDispatch		= $AA54;						{  Text Services Manager  }
	_CursorDeviceDispatch		= $AADB;						{  Cursor Device Manager  }
	_QDExtensions2				= $ABE0;						{  CursorComponent routines  }
																{  Miscellaneous Traps  }
	_InitDogCow					= $A89F;
	_EnableDogCow				= $A89F;
	_DisableDogCow				= $A89F;
	...
	_OCEUtils					= $AA5C;						{  PowerTalk (AOCE) }
	_DigitalSignature			= $AA5D;						{  PowerTalk (AOCE) }
	_TBDispatch					= $AA5E;						{  PowerTalk (AOCE) }

	_CollectionMgr				= $ABF6;						{  Collection Manager }

	_ControlStripDispatch		= $AAF2;						{  see TechNote OS 06 }
	_ExpansionManager			= $AAF3;
	_PowerMgrDispatch			= $A09E;

	_ALMDispatch				= $AAA4;						{  Apple Location Manger }

	_ServerDispatch				= $A094;						{  AppleShare, Macintosh File Sharing  }

	_FSMDispatch				= $A0AC;						{  File System Manager }
	_HFSUtilDispatch			= $A824;						{  HFS Utility routines in the File System Manager }
	...
	_SysDebugDispatch			= $AA7E;
	_AVLTreeDispatch			= $AA80;
	_FileMappingDispatch		= $AA81;
...
{$SETC UsingIncludes := TrapsIncludes}

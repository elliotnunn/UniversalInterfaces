...
#define kAVPanelSelectorGetFocusStatusSelect  262
#define kAVPanelSelectorSetFocusStatusSelect  263
...
#define kAVPortGetDisplayTimingCountSelect  516
#define kAVPortGetIndexedDisplayTimingSelect  517
#define kAVPortGetDisplayTimingRangeCountSelect  518
#define kAVPortGetIndexedDisplayTimingRangeSelect  519

...
#define sigAdobePremiere 				'PrMr'				/*  was previously misspelled as sigAdobePremier */
#define ftAdobePremiereMovie 			'MooV'				/*  was previously misspelled as ftAdobePremierMovie */

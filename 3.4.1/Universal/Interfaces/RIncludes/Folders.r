...
#define kLocalesFolderType 				'ƒloc'				/*  PKE for Locales folder  */
...
#define kAppleshareAutomountServerAliasesFolderType  'srvƒ'	/*  Appleshare puts volumes to automount inside this folder.  */
#define kPreMacOS91ApplicationsFolderType  'åpps'			/*  The "Applications" folder, pre Mac OS 9.1  */
#define kPreMacOS91InstallerLogsFolderType  'îlgf'			/*  The "Installer Logs" folder, pre Mac OS 9.1  */
#define kPreMacOS91AssistantsFolderType  'åstƒ'				/*  The "Assistants" folder, pre Mac OS 9.1  */
#define kPreMacOS91UtilitiesFolderType 	'ütiƒ'				/*  The "Utilities" folder, pre Mac OS 9.1  */
#define kPreMacOS91AppleExtrasFolderType  'åexƒ'			/*  The "Apple Extras" folder, pre Mac OS 9.1  */
#define kPreMacOS91MacOSReadMesFolderType  'µorƒ'			/*  The "Mac OS ReadMes" folder, pre Mac OS 9.1  */
#define kPreMacOS91InternetFolderType 	'întƒ'				/*  The "Internet" folder, pre Mac OS 9.1  */
#define kPreMacOS91AutomountedServersFolderType  'ßrvƒ'		/*  The "Servers" folder, pre Mac OS 9.1  */
#define kPreMacOS91StationeryFolderType  'ødst'				/*  The "Stationery" folder, pre Mac OS 9.1  */

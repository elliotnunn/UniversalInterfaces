...
#define kInternationResourcesIcon 		'ifil'				/*  old misspelling */
...
#define kControlStripModulesFolderIcon 	'sdvƒ'
...
#define kHelpFolderIcon 				'ƒhlp'
#define kInternetFolderIcon 			'intƒ'
#define kInternetPlugInFolderIcon 		'ƒnet'
#define kInternetSearchSitesFolderIcon 	'issf'
#define kLocalesFolderIcon 				'ƒloc'
#define kMacOSReadMeFolderIcon 			'morƒ'
#define kPublicFolderIcon 				'pubf'
#define kPreferencesFolderIcon 			'prfƒ'
#define kPrinterDescriptionFolderIcon 	'ppdf'
#define kPrinterDriverFolderIcon 		'ƒprd'
...
#define kScriptingAdditionsFolderIcon 	'ƒscr'
#define kSharedLibrariesFolderIcon 		'ƒlib'
#define kScriptsFolderIcon 				'scrƒ'
...
#define kTextEncodingsFolderIcon 		'ƒtex'
#define kUsersFolderIcon 				'usrƒ'
#define kUtilitiesFolderIcon 			'utiƒ'
